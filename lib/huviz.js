...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.render_node_info_box = function() {
      var all_names, color, color_headers, dialogArgs, id_display, j, len1, len2, len3, len4, link_from, name, names_all_langs, node_info, node_out_links, node_type, note, o, other_types, p, ref, ref1, ref2, ref3, target, target_prefix, width, z;
      ...
      if (this.focused_node._colors) {
        ...
        ref3 = this.focused_node._colors;
    ...
    Huviz.prototype.nodesAreAdjacent = function(n1, n2) {
      var busyNode, j, len1, len2, link, lonelyNode, o, ref, ref1, ref2, ref3;
    ...
    Huviz.prototype.create_tabs = function() {
      var elem, html, j, jQElem_list, len1, pair, ref;
    ...
    function Huviz(incoming_args) {
      ...
      this.init_settings_from_json = bind(this.init_settings_from_json, this);
      this.dump_current_settings = bind(this.dump_current_settings, this);
      ...
      this.populate_graphs_selector = bind(this.populate_graphs_selector, this);
  ...
  Orlando = (function(superClass) {
    ...
    Orlando.prototype.push_snippet = function(msg_or_obj) {
      var dataType, dataType_curie, dataType_uri, fontSize, m, obj, obj_dd, ref;
      obj = msg_or_obj;
