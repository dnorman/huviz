...
angliciser = function angliciser(lst, and_or_or) {
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).angliciser = angliciser;
"use strict"; // ((str) => alert(str))('boo') ;

var _treepicker = require("treepicker");
...
ColoredTreePicker = function () {
  var ColoredTreePicker =
  /*#__PURE__*/
  function (_TreePicker) {
    _inherits(ColoredTreePicker, _TreePicker);

    function ColoredTreePicker() {
      var _this;

      _classCallCheck(this, ColoredTreePicker);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(ColoredTreePicker).apply(this, arguments)); // FIXME @recolor_now() unless handled externally

      _this.recolor_now = _this.recolor_now.bind(_assertThisInitialized(_this)); //else
      //  msg = "get_color_forId_byName(" + id + ") failed because @id_to_colors[id] not found"
      //  return 'pink'

      _this.click_handler = _this.click_handler.bind(_assertThisInitialized(_this));
      _this.id_to_colors = {};
      return _this;
    }

    _createClass(ColoredTreePicker, [{
      key: "add",
      value: function add(id, parent_id, name, listener) {
        return _get(_getPrototypeOf(ColoredTreePicker.prototype), "add", this).call(this, id, parent_id, name, listener);
      }
    }, {
      key: "recolor_now",
      value: function recolor_now() {
      ...
      key: "get_my_style_id",
      value: function get_my_style_id() {
        return "".concat(this.get_my_id(), "_colors");
      }
    }, {
      key: "update_css",
      value: function update_css() {
        ...
        for (id in ref) {
          ...
          nc = colors.unshowing;
          sc = colors.showing;
          styles += "\n".concat(ctxSel, "#").concat(id, ".treepicker-showing {\n   background-color:").concat(sc, ";\n}\n").concat(ctxSel, "#").concat(id, ".treepicker-unshowing {\n   background-color:").concat(nc, ";\n}\n").concat(ctxSel, "#").concat(id, ".treepicker-mixed,\n").concat(ctxSel, "#").concat(id, ".treepicker-indirect-mixed.treepicker-collapse {\n  background: linear-gradient(45deg, ").concat(nc, ", ").concat(sc, ", ").concat(nc, ", ").concat(sc, ", ").concat(nc, ", ").concat(sc, ", ").concat(nc, ", ").concat(sc, ");\n  background-color: transparent;\n}");
        }

        this.style_sheet.html(styles);

        if (false) {
          // cross-check the stylesheets to ensure proper loading
      ...
      key: "recolor_recurse_DOM",
      value: function recolor_recurse_DOM(retval, recursor, branch, indent) {
      ...
      key: "recolor_node",
      value: function recolor_node(retval, recursor, id, elem_raw, indent) {
        var elem, hue, ref;
      ...
      key: "get_current_color_forId",
      value: function get_current_color_forId(id) {
        var state;
        state = this.id_to_state[true][id];
        return this.get_color_forId_byName(id, state);
      }
    }, {
      key: "get_color_forId_byName",
      value: function get_color_forId_byName(id, state_name) {
        var colors;
      ...
      value: function click_handler() {
        var id;
        boundMethodCheck(this, ColoredTreePicker);
        id = _get(_getPrototypeOf(ColoredTreePicker.prototype), "click_handler", this).call(this);
        return this.style_with_kid_color_summary_if_needed(id);
      }
    }, {
      key: "style_with_kid_color_summary_if_needed",
      value: function style_with_kid_color_summary_if_needed(id) {
        if (this.should_be_colored_by_kid_summary(id)) {
          return this.style_with_kid_color_summary(id);
        }
      }
    }, {
      key: "should_be_colored_by_kid_summary",
      value: function should_be_colored_by_kid_summary(id) {
        return !this.is_leaf(id) && this.id_is_collapsed[id];
      }
    }, {
      key: "collapse_by_id",
      value: function collapse_by_id(id) {
        _get(_getPrototypeOf(ColoredTreePicker.prototype), "collapse_by_id", this).call(this, id);

        return this.style_with_kid_color_summary_if_needed(id);
      }
    }, {
      key: "expand_by_id",
      value: function expand_by_id(id) {
        if (this.should_be_colored_by_kid_summary(id)) {
          this.id_to_elem[id].attr("style", ""); // clear style set by set_gradient_style
        }

        return _get(_getPrototypeOf(ColoredTreePicker.prototype), "expand_by_id", this).call(this, id);
      }
    }, {
      key: "summarize_kid_colors",
      value: function summarize_kid_colors(id, color_list) {
      ...
      key: "style_with_kid_color_summary",
      value: function style_with_kid_color_summary(id) {
        var color_list;
      ...
      key: "set_gradient_style",
      value: function set_gradient_style(id, kid_colors) {
        var colors, style;
        colors = kid_colors.join(', ');
        style = "background-color: transparent;";
        style += " background: linear-gradient(45deg, ".concat(colors, ")");
        return this.id_to_elem[id].attr("style", style);
      }
    }, {
      key: "set_payload",
      value: function set_payload(id, value) {
        _get(_getPrototypeOf(ColoredTreePicker.prototype), "set_payload", this).call(this, id, value); // REVIEW it works but is this the right time to do this?
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).ColoredTreePicker = ColoredTreePicker;
"use strict";
...
function (_Huviz) {
  ...
  function Deprecated() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Deprecated).apply(this, arguments));
    _this.onnextsubject = _this.onnextsubject.bind(_assertThisInitialized(_this));
    _this.onnextsubject = _this.onnextsubject.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(Deprecated, [{
    key: "hide_all_links",
    value: function hide_all_links() {
      var _this2 = this;

      this.nodes.forEach(function (node) {
        //node.linked = false;
        //node.fixed = false;	
        _this2.shelved_set.acquire(node);
        ...
        return _this2.update_showing_links(node);
      });
      this.links_set.forEach(function (link) {
        return _this2.remove_ghosts(link);
      });
      this.links_set.clear();
      this.chosen_set.clear(); // It should not be neccessary to clear discarded_set or hidden_set()
    ...
    key: "fire_nextsubject_event",
    value: function fire_nextsubject_event(oldquad, newquad) {
    ...
    key: "onnextsubject",
    value: function onnextsubject(e) {
      var subject;
      boundMethodCheck(this, Deprecated);
      alert("sproing"); //console.log "onnextsubject: called",e
      ...
      this.calls_to_onnextsubject++; //console.log "count:",@calls_to_onnextsubject
    ...
    key: "show_found_links",
    value: function show_found_links() {
      var _this3 = this;
      ...
      for (sub_id in this.G.subjects) {
        ...
        subj.getValues("f:name").forEach(function (name) {
          ...
          if (name.match(_this3.search_regex)) {
            node = _this3.get_or_make_node(subj, [cx, cy]);

            if (node) {
              return _this3.show_node_links(node);
            }
          }
        });
      }
    ...
    key: "get_or_make_node",
    value: function get_or_make_node(subject, start_point, linked, into_set) {
      ...
      name = name_obj.value != null && name_obj.value || name_obj; //name = subject.predicates[FOAF_name].objects[0].value
      ...
      this.add_node_ghosts(d); //n_idx = @add_to_array(d, @nodes)
    ...
    key: "find_links_from_node",
    value: function find_links_from_node(node) {
      var _this4 = this;
        ...
        for (p_name in subj.predicates) {
          ...
          predicate.objects.forEach(function (obj, i) {
            if (obj.type === RDF_object) {
              target = _this4.get_or_make_node(_this4.G.subjects[obj.value], pnt);
            }

            if (target) {
              return _this4.add_link(new Edge(node, target));
            }
          });
        }
      }
    ...
    key: "find_links_to_node",
    value: function find_links_to_node(d) {
      var _this5 = this;
      ...
      if (subj) {
        ...
        this.G.get_incoming_predicates(subj).forEach(function (sid_pred) {
          ...
          sid = sid_pred[0];
          pred = sid_pred[1];
          src = _this5.get_or_make_node(_this5.G.subjects[sid], parent_point);
          return _this5.add_link(new Edge(src, d));
        });
      }
    ...
    key: "set_type_if_possible",
    value: function set_type_if_possible(subj, quad, force) {
      var name, pred_id; // This is a hack, ideally we would look on the subject for type at coloring
    ...
    value: function hide_all_links() {
      ...
      this.nodes.forEach(function (node) {
        //node.linked = false;
        //node.fixed = false;	
        _this6.shelved_set.acquire(node);
        ...
        return _this6.update_showing_links(node);
      });
      this.links_set.forEach(function (link) {
        return _this6.remove_ghosts(link);
      });
      this.links_set.clear();
      this.chosen_set.clear(); // It should not be neccessary to clear discarded_set or hidden_set()
      // because shelved_set.acquire() should have accomplished that
    ...
    value: function show_found_links() {
      ...
      for (sub_id in this.G.subjects) {
        ...
        subj.getValues("f:name").forEach(function (name) {
          ...
          if (name.match(_this7.search_regex)) {
            node = _this7.get_or_make_node(subj, [cx, cy]);

            if (node) {
              return _this7.show_node_links(node);
            }
          }
        });
      }
    ...
    value: function find_links_from_node(node) {
      ...
      if (subj) {
        for (p_name in subj.predicates) {
          ...
          predicate.objects.forEach(function (obj, i) {
            if (obj.type === RDF_object) {
              target = _this8.get_or_make_node(_this8.G.subjects[obj.value], pnt);
            }

            if (target) {
              return _this8.add_link(new Edge(node, target));
            }
          });
        }
      }
    ...
    value: function find_links_to_node(d) {
      ...
      if (subj) {
        ...
        this.G.get_incoming_predicates(subj).forEach(function (sid_pred) {
          ...
          sid = sid_pred[0];
          pred = sid_pred[1];
          src = _this9.get_or_make_node(_this9.G.subjects[sid], parent_point);
          return _this9.add_link(new Edge(src, d));
        });
      }
  ...
  return Deprecated;
}(Huviz); //console.log "   ",subj.type


(typeof exports !== "undefined" && exports !== null ? exports : void 0).Deprecated = Deprecated;
"use strict";
...
Edge = function () {
  ...
  function () {
    function Edge(source, target, predicate) {
      ...
      this.source = source;
      this.target = target;
      this.predicate = predicate; // FIXME if everything already has .lid then remove the test "not a.lid?"
    ...
    _createClass(Edge, [{
      ...
      key: "register_context",
      value: function register_context(context) {
      ...
      key: "an_end_is_selected",
      value: function an_end_is_selected() {
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).Edge = Edge;
"use strict";
...
EditController = function () {
  var EditController =
  /*#__PURE__*/
  function (_FiniteStateMachine) {
    _inherits(EditController, _FiniteStateMachine);
    ...
    function EditController(huviz) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(EditController).call(this)); //@huviz.set_edit_mode(true)

      _this.toggle_edit_form = _this.toggle_edit_form.bind(_assertThisInitialized(_this));
      _this.huviz = huviz; //TODO EditController should be loaded and checked when a dataset is loaded

      _this.userValid = true; //TODO this needs to be hooked into authentication -- remove to huviz.coffee to validate against dataloaded and authentication
      //@userValid = false

      _this.ensure_verbs();

      _this.build_transitions();
    ...
    _createClass(EditController, [{
      key: "build_transitions",
      value: function build_transitions() {
      ...
      key: "on__prepare",
      value: function on__prepare() {
        var clearForm, new_viscanvas, saveForm, validateForm, viscanvas;

        if (this.userValid === true && !this.con) {
          //document.getElementsByClassName("edit-controls")[0] is undefined
          this.con = document.createElement("div");
          this.con.className = "edit-controls loggedIn";
          this.con.setAttribute("edit", "no"); //@huviz.set_edit_mode(false)
          ...
          this.con.getElementsByClassName("slider")[0].onclick = this.toggle_edit_form; //console.log(con.getElementsByTagName("form")[0])
      ...
      key: "on__disable",
      value: function on__disable() {
        this.hide_verbs();
        return this.hide_form();
      }
    }, {
      key: "on__enable",
      value: function on__enable() {
        this.show_verbs();
        return this.show_form();
      }
    }, {
      key: "get_verb_set",
      value: function get_verb_set() {
        return {
          ...
          // aka subclass / subpropertize
          annotate: this.huviz.human_term.annotate
        };
      }
    }, {
      key: "add_verbs",
      value: function add_verbs() {
        var prepend, vset;
      ...
      key: "hide_verbs",
      value: function hide_verbs() {
        return this.my_verbs.style('display', 'none');
      }
    }, {
      key: "show_verbs",
      value: function show_verbs() {
        return this.my_verbs.style('display', 'flex');
      }
    }, {
      key: "create_edit_form",
      value: function create_edit_form(toggleEdit) {
        var formNode;
      ...
      key: "set_predicate_selector",
      value: function set_predicate_selector() {
        var availablePredicates, j, len, predicate, ref; //console.log("setting predicate selector in edit form")
      ...
      key: "update_predicate_picked",
      value: function update_predicate_picked(event, ui) {
        var new_pred_value; //if event.type is 'autocompletechange'

        new_pred_value = this.predicate_input.value;
        console.log("".concat(new_pred_value, " is new predicate"));
      ...
      value: function toggle_edit_form() {
        var toggleEditMode;
        boundMethodCheck(this, EditController);
        toggleEditMode = this.con.getAttribute("edit"); //debugger

        if (toggleEditMode === 'no') {
          //toggle switched to edit mode, then show form
          this.show_verbs();
          this.show_form();
        }

        if (toggleEditMode === 'yes') {
          //toggle switched to normal mode, then hide form
          this.hide_verbs();
          return this.hide_form();
        }
      }
    }, {
      key: "validate_edit_form",
      value: function validate_edit_form(evt) {
      ...
      key: "predicate_is_DatatypeProperty",
      value: function predicate_is_DatatypeProperty() {
        var current_value; // The job of figuring this out is best done in a method because:
      ...
      key: "adjust_object_datatype",
      value: function adjust_object_datatype() {
      ...
      key: "clear_edit_form",
      value: function clear_edit_form() {
        ...
        if (this.proposed_quad) {
          console.log("@proposed_quad:", this.proposed_quad); //@huviz.set_proposed_edge(null)
      ...
      key: "set_subject_node",
      value: function set_subject_node(node) {
        var new_value;
        ...
        console.log("set_subject_node() id:'".concat(new_value, "'"));
      ...
      key: "set_object_node",
      value: function set_object_node(node) {
        // either a node or undefined
        var new_value;
        ...
        new_value = node && node.id || "";
        console.log("set_object_node() id:'".concat(new_value, "'"));
        this.object_input.setAttribute("value", new_value);
        this.validate_edit_form();
        return this.validate_proposed_edge();
      }
    }, {
      key: "validate_proposed_edge",
      value: function validate_proposed_edge() {
        // type = subject or object
        var RDF_literal, RDF_object, obj_type, object_id, predicate_val, q, subject_id;
        console.log('validate_proposed_edge()'); // What are the proposed subject node, object node and predicate?
        ...
        predicate_val = this.predicate_input.value; // propose a new quad once there is a subject and an object
        ...
        if (subject_id && object_id) {
          ...
          if (this.proposed_quad != null && this.quads_match(q, this.proposed_quad)) {
            console.log("... skipping: <s:".concat(q.s, ", p:").concat(q.p, ", o:").concat(q.o.value, "> matches old"));
            return;
          }

          console.log("... accepting: <s:".concat(q.s, ", p:").concat(q.p, ", o:").concat(q.o.value, ">"));
          return this.set_proposed_quad(q);
        }
      }
    }, {
      key: "quads_match",
      value: function quads_match(a, b) {
        return a.s === b.s && a.p === b.p && a.o.value === b.o.value;
      }
    }, {
      key: "set_proposed_quad",
      value: function set_proposed_quad(new_q) {
        console.log("set_proposed_quad()"); // If there is an existing edge remove it before setting a new proposed edge

        if (this.proposed_quad) {
          // There can only be one, so get rid of old proposed edge
      ...
      key: "add_proposed_quad",
      value: function add_proposed_quad(q) {
        var edge;
      ...
      key: "remove_proposed_quad",
      value: function remove_proposed_quad() {
        var edge_id, old_edge;
        old_edge = this.huviz.proposed_edge;

        if (old_edge) {
          edge_id = old_edge.id;
          this.huviz.set_proposed_edge(null); //@huviz.remove_link(edge_id)
...
function () {
  ...
  _createClass(FiniteStateMachine, [{
    key: "call_method_by_name",
    value: function call_method_by_name(meth_name) {
      var meth;
    ...
    value: function set_state(state) {
      var called; // call a method when arriving at the new state, if it exists
    ...
    key: "is_state",
    value: function is_state(candidate) {
      return this.state === candidate;
    }
  }, {
    key: "make_noop_msg",
    value: function make_noop_msg(trans_id, old_state, new_state) {
      return this.constructor.name + " had neither " + "on__".concat(trans_id, " exit__").concat(old_state, " or enter__").concat(new_state);
    }
  }, {
    key: "throw_log_or_ignore_msg",
    value: function throw_log_or_ignore_msg(msg) {
    ...
    key: "transit",
    value: function transit(trans_id) {
      ...
      if (transition = this.transitions[trans_id]) {
        ...
        this.throw_log_or_ignore_msg("".concat(this.constructor.name, " has no transition with id ").concat(trans_id));
      }
    }
  }]);
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).FiniteStateMachine = FiniteStateMachine;
"use strict";
...
getRandomId = function getRandomId(prefix) {
  var max;
  max = 10000000000;
  prefix = prefix || 'id';
...
CommandController = function () {
  ...
  function () {
    function CommandController(huviz, container, hierarchy) {
      ...
      this.add_predicate = this.add_predicate.bind(this); //@prepare_command(@new_GraphCommand( {}))
      ...
      this.add_clear_both(this.comdiv); //@node_pickers = @comdiv.append('div')
    ...
    _createClass(CommandController, [{
      key: "control_label",
      value: function control_label(txt, what, title) {
        var label, outer;
      ...
      key: "new_GraphCommand",
      value: function new_GraphCommand(args) {
        return new gcl.GraphCommand(this.huviz, args);
      }
    }, {
      key: "reset_graph",
      value: function reset_graph() {
        /*
        * unhide all
        * retrieve all
        * shelve all
      ...
      key: "make_command_history",
      value: function make_command_history() {
        var history;
        ...
        this.scriptPlayerControls = history.append('div').attr('class', 'scriptPlayerControls'); //  attr('style','position: relative;  float:right')
        ...
        this.scriptPlayButton.append('i').attr("class", "fa fa-play"); //attr('style', 'display:none').
        ...
        this.scriptStashButton.append('i').attr("class", "fa fa-bars"); //.append('span').text('save to menu')
        //history.append('div')

        this.cmdlist = history.append('div').attr('class', 'commandlist');
        this.oldcommands = this.cmdlist.append('div').attr('class', 'commandhistory').style('max-height', "".concat(this.huviz.height - 80, "px"));
      ...
      key: "reset_command_history",
      value: function reset_command_history() {
      ...
      key: "get_downloadscript_name",
      value: function get_downloadscript_name(ext) {
        return this.lastScriptName || 'HuVizScript.' + ext;
      }
    }, {
      key: "get_script_prefix",
      value: function get_script_prefix() {
      ...
      key: "get_script_body",
      value: function get_script_body() {
        return this.get_script_prefix() + this.oldcommands.text();
      }
    }, {
      key: "get_script_body_as_json",
      value: function get_script_body_as_json() {
        ...
        replacer = function replacer(key, value) {
          var j, k, len1, len2, node_or_id, obj, retlist, setId, set_or_id; // replacer() removes non-literals from GraphCommand.args_or_script for serialization
      ...
      key: "get_script_body_as_hybrid",
      value: function get_script_body_as_hybrid() {
      ...
      key: "make_txt_script_href",
      value: function make_txt_script_href() {
        var theBod, theHref;
      ...
      key: "make_json_script_href",
      value: function make_json_script_href() {
        var theHref, theJSON;
      ...
      key: "make_hybrid_script_href",
      value: function make_hybrid_script_href() {
        var theBod, theHref;
      ...
      key: "on_downloadscript_json_clicked",
      value: function on_downloadscript_json_clicked() {
        this.on_downloadscript_type('json');
      }
    }, {
      key: "on_downloadscript_txt_clicked",
      value: function on_downloadscript_txt_clicked() {
        this.on_downloadscript_type('txt');
      }
    }, {
      key: "on_downloadscript_hybrid_clicked",
      value: function on_downloadscript_hybrid_clicked() {
        this.on_downloadscript_type('hybrid', 'txt');
      }
    }, {
      key: "on_downloadscript_type",
      value: function on_downloadscript_type(scriptFileType, ext) {
      ...
      key: "on_stashscript_clicked",
      value: function on_stashscript_clicked() {
      ...
      key: "on_rewind_click",
      value: function on_rewind_click() {
        this.reset_graph();
        this.command_idx0 = 0;
        return this.update_script_buttons();
      }
    }, {
      key: "on_backward_click",
      value: function on_backward_click() {
        var forward_to_idx;
      ...
      key: "on_forward_click",
      value: function on_forward_click() {
        this.play_old_command_by_idx(this.command_idx0);
        this.command_idx0++;
        return this.update_script_buttons();
      }
    }, {
      key: "on_fastforward_click",
      value: function on_fastforward_click(forward_to_idx) {
        var results;
      ...
      key: "play_old_command_by_idx",
      value: function play_old_command_by_idx(idx) {
        var record;
      ...
      key: "play_old_command",
      value: function play_old_command(cmd) {
        cmd.skip_history = true;
        cmd.skip_history_remove = true;
        return this.huviz.run_command(cmd);
      }
    }, {
      key: "install_listeners",
      value: function install_listeners() {
      ...
      key: "on_dataset_loaded",
      value: function on_dataset_loaded(evt) {
        if (evt.done == null) {
          $(this.container).show();
          this.show_succession_of_hints();
          this.huviz.perform_tasks_after_dataset_loaded();
          this.huviz.hide_state_msg(); // FIXME is there a standards-based way to prevent this happening three times?

          return evt.done = true;
        }
      }
    }, {
      key: "show_succession_of_hints",
      value: function show_succession_of_hints() {
        var i, len, ref, reminder; // Show the reminders, give them close buttons which reveal them in series
      ...
      key: "select_the_initial_set",
      value: function select_the_initial_set() {
        this.OLD_select_the_initial_set();
      }
    }, {
      key: "NEW_select_the_initial_set",
      value: function NEW_select_the_initial_set() {
      ...
      key: "OLD_select_the_initial_set",
      value: function OLD_select_the_initial_set() {
        var _this = this;

        var rm_cmd, toggleEveryThing; // TODO initialize the taxon coloring without cycling all

        rm_cmd = function rm_cmd() {
          // more hideous hackery: remove toggleTaxonThing from script
          return _this.delete_script_command_by_idx(0);
        };

        toggleEveryThing = function toggleEveryThing() {
          _this.huviz.toggle_taxon("Thing", false); //, () -> alert('called'))


          return setTimeout(rm_cmd, 1000);
        };

        toggleEveryThing.call(); // everyThingIsSelected = () =>
        ...
        setTimeout(this.push_future_onto_history, 1800); //@huviz.do({verbs: ['unselect'], sets: [], skip_history: true})

        this.huviz.shelved_set.resort(); // TODO remove when https://github.com/cwrc/HuViz/issues/109
      }
    }, {
      key: "check_until_then",
      value: function check_until_then(checkCallback, thenCallback) {
        var intervalId, nag;

        nag = function nag() {
          if (checkCallback.call()) {
            clearInterval(intervalId); //alert('check_until_then() is done')
      ...
      key: "init_editor_data",
      value: function init_editor_data() {
      ...
      key: "disengage_command",
      value: function disengage_command() {
        this.clear_like();
        this.disengage_all_verbs();
        this.disengage_all_sets();
        return this.update_command();
      ...
      key: "add_clear_both",
      value: function add_clear_both(target) {
        // keep taxonomydiv from being to the right of the verbdiv
        return target.append('div').attr('style', 'clear:both');
      }
    }, {
      key: "ignore_predicate",
      value: function ignore_predicate(pred_id) {
        return this.predicates_ignored.push(pred_id);
      }
    }, {
      key: "handle_newpredicate",
      value: function handle_newpredicate(e) {
        ...
        if (indexOf.call(this.predicates_ignored, pred_uri) < 0) {
          // FIXME merge with predicates_to_ignore
      ...
      key: "recolor_edges_and_predicates_eventually",
      value: function recolor_edges_and_predicates_eventually() {
      ...
      key: "recolor_edges_and_predicates",
      value: function recolor_edges_and_predicates(evt) {
      ...
      key: "build_predicate_picker",
      value: function build_predicate_picker(label) {
        ...
        this.predicatebox = where.append('div').classed('container', true).attr('id', this.predicates_id); //@predicatebox.attr('class','scrolling')
      ...
      key: "add_predicate",
      value: function add_predicate(pred_lid, parent_lid, pred_name) {
      ...
      key: "make_predicate_proposable",
      value: function make_predicate_proposable(pred_lid) {
        var _this2 = this;
        ...
        predicate_ctl.on('mouseenter', function () {
          ...
          every = !!_this2.predicate_picker.id_is_collapsed[pred_lid];
          nextStateArgs = _this2.predicate_picker.get_next_state_args(pred_lid);

          if (nextStateArgs.new_state === 'showing') {
            _this2.proposed_verb = 'draw';
          } else {
            _this2.proposed_verb = 'undraw';
          }

          _this2.regarding = [pred_lid];
          _this2.regarding_every = !!_this2.predicate_picker.id_is_collapsed[pred_lid];
          ready = _this2.prepare_command(_this2.build_command());
        });
        return predicate_ctl.on('mouseleave', function () {
          _this2.proposed_verb = null;
          _this2.regarding = null;

          _this2.prepare_command(_this2.build_command());
        });
      }
    }, {
      key: "handle_on_predicate_clicked",
      value: function handle_on_predicate_clicked(pred_id, new_state, elem, args) {
        var _this3 = this;

        this.start_working();
        return setTimeout(function () {
          // run asynchronously so @start_working() can get a head start
          return _this3.on_predicate_clicked(pred_id, new_state, elem, args);
        });
      }
    }, {
      key: "on_predicate_clicked",
      value: function on_predicate_clicked(pred_id, new_state, elem, args) {
      ...
      key: "recolor_edges",
      value: function recolor_edges(evt) {
      ...
      key: "build_taxon_picker",
      value: function build_taxon_picker(label, where) {
        ...
        this.taxon_box.attr('style', 'vertical-align:top'); // http://en.wikipedia.org/wiki/Taxon
      ...
      key: "add_taxon",
      value: function add_taxon(taxon_id, parent_lid, class_name, taxon) {
      ...
      key: "make_taxon_proposable",
      value: function make_taxon_proposable(taxon_id) {
        var _this4 = this;

        var taxon_ctl;
        taxon_ctl = this.taxon_picker.id_to_elem[taxon_id];
        taxon_ctl.on('mouseenter', function (evt) {
          var ready; //evt.stopPropagation()
          // REVIEW consider @taxon_picker.get_next_state_args(taxon_id) like make_predicate_proposable()

          _this4.proposed_taxon = taxon_id;
          _this4.proposed_every = !!_this4.taxon_picker.id_is_collapsed[taxon_id];

          if (!_this4.engaged_verbs.length) {
            // only presume that select/unselect is what is happening when no other verbs are engaged
            if (_this4.engaged_taxons.includes(taxon_id)) {
              _this4.proposed_verb = 'unselect';
            } else {
              _this4.proposed_verb = 'select';
            }
          } //console.log(@proposed_verb, @proposed_taxon)


          ready = _this4.prepare_command(_this4.build_command());
        });
        taxon_ctl.on('mouseleave', function (evt) {
          var ready;
          _this4.proposed_taxon = null;
          _this4.proposed_verb = null;
          ready = _this4.prepare_command(_this4.build_command());
        });
      }
    }, {
      key: "onChangeEnglish",
      value: function onChangeEnglish(evt) {
        this.object_phrase = evt.detail.english; //console.log("%c#{@object_phrase}",'color:orange;font-size:2em')

        this.prepare_command(this.build_command());
        return this.update_command();
      }
    }, {
      key: "handle_on_taxon_clicked",
      value: function handle_on_taxon_clicked(id, new_state, elem, args) {
        var _this5 = this;

        this.start_working();
        return setTimeout(function () {
          // run asynchronously so @start_working() can get a head start
          return _this5.on_taxon_clicked(id, new_state, elem, args);
        });
      }
    }, {
      key: "set_taxa_click_storm_callback",
      value: function set_taxa_click_storm_callback(callback) {
      ...
      key: "taxa_being_clicked_increment",
      value: function taxa_being_clicked_increment() {
      ...
      key: "taxa_being_clicked_decrement",
      value: function taxa_being_clicked_decrement() {
        if (this.taxa_being_clicked == null) {
        ...
        this.taxa_being_clicked--; //console.log("taxa_being_clicked_decrement() after:", @taxa_being_clicked)
      ...
      key: "make_run_transient_and_cleanup_callback",
      value: function make_run_transient_and_cleanup_callback(because) {
        var _this6 = this;
        ...
        return function (err) {
          ...
          _this6.huviz.clean_up_all_dirt();

          _this6.run_any_immediate_command({});

          _this6.perform_any_cleanup(because);
        };
      }
    }, {
      key: "on_taxon_clicked",
      value: function on_taxon_clicked(taxonId, new_state, elem, args) {
        ...
        if (new_state === 'showing') {
          if (old_state === 'mixed' || old_state === 'unshowing' || old_state === 'empty') {
            ...
            console.error("no action needed because ".concat(taxonId, ".").concat(old_state, " == ").concat(new_state));
          }
          ...
          console.error("".concat(taxonId, ".old_state should NOT equal 'hidden' here"));
        }
      ...
      key: "unselect_node_class",
      value: function unselect_node_class(node_class) {
      ...
      key: "should_be_immediate_mode",
      value: function should_be_immediate_mode() {
        return !this.is_verb_phrase_empty() && this.is_command_object_empty() && !this.liking_all_mode;
      }
    }, {
      key: "is_command_object_empty",
      value: function is_command_object_empty() {
        return this.huviz.selected_set.length === 0 && this.chosen_set == null;
      }
    }, {
      key: "is_verb_phrase_empty",
      value: function is_verb_phrase_empty() {
        return this.engaged_verbs.length === 0;
      }
    }, {
      key: "auto_change_verb_if_warranted",
      value: function auto_change_verb_if_warranted(node) {
      ...
      value: function build_form() {
        ...
        this.build_depth();
        this.build_like();
        this.nextcommand = this.nextcommandbox.append('div').attr('class', 'nextcommand command'); // Where the full command string to appear as plain text, eg:
        //    "____ every Thing."
        //    "shelve every Person."
      ...
      key: "stop_working",
      value: function stop_working() {
        this.show_working_off();
        return this.already_working = void 0;
      }
    }, {
      key: "show_working_on",
      value: function show_working_on(cmd) {
      ...
      key: "show_working_off",
      value: function show_working_off() {
      ...
      key: "handle_clear_like",
      value: function handle_clear_like(evt) {
        this.like_input.property('value', '');
        return this.handle_like_input();
      }
    }, {
      key: "handle_like_input",
      value: function handle_like_input(evt) {
        ...
        if (like_has_a_value) {
          ...
          if (this.liking_all_mode) {
            // but it DID
            TODO = "restore the state before liking_all_mode " + "eg select a different set or disable all set selection"; //alert(TODO+" was: #{@chosen_set_before_liking_all}")
      ...
      value: function build_submit() {
        ...
        this.doit_butt.on('click', function () {
          if (_this7.update_command()) {
            return _this7.huviz.run_command(_this7.command);
          }
      ...
      key: "enable_doit_button",
      value: function enable_doit_button() {
        return this.doit_butt.attr('disabled', null);
      }
    }, {
      key: "disable_doit_button",
      value: function disable_doit_button() {
        return this.doit_butt.attr('disabled', 'disabled');
      }
    }, {
      key: "hide_doit_button",
      value: function hide_doit_button() {
        return $(this.doit_butt[0][0]).hide();
      }
    }, {
      key: "show_doit_button",
      value: function show_doit_button() {
        return $(this.doit_butt[0][0]).show();
      }
    }, {
      key: "set_immediate_execution_mode",
      value: function set_immediate_execution_mode(which) {
        if (which) {
      ...
      key: "update_immediate_execution_mode_as_warranted",
      value: function update_immediate_execution_mode_as_warranted() {
        return this.set_immediate_execution_mode(this.should_be_immediate_execution_mode());
      }
    }, {
      key: "disengage_all_verbs",
      value: function disengage_all_verbs() {
      ...
      key: "unselect_all_node_classes",
      value: function unselect_all_node_classes() {
      ...
      key: "clear_like",
      value: function clear_like() {
        return this.huviz.like_string();
      }
    }, {
      key: "get_like_string",
      value: function get_like_string() {
        return this.like_input[0][0].value;
      }
    }, {
      key: "push_command",
      value: function push_command(cmd) {
        throw new Error('DEPRECATED');
        return this.push_command_onto_history(cmd);
      }
    }, {
      key: "push_cmdArgs_onto_future",
      value: function push_cmdArgs_onto_future(cmdArgs) {
        return this.future_cmdArgs.push(cmdArgs);
      }
    }, {
      key: "push_future_onto_history",
      value: function push_future_onto_history() {
      ...
      key: "push_command_onto_history",
      value: function push_command_onto_history(cmd) {
        var _this8 = this;

        var delete_button, elem, elem_and_cmd, idx_of_this_command; // Maybe the command_pointer is in the middle of the command_list and here
        ...
        idx_of_this_command = this.command_idx0; // we are appending to the end of the script, playing is no longer valid, so...
        ...
        delete_button.on('click', function () {
          return _this8.delete_script_command_by_id(cmd.id);
        });
        return this.update_script_buttons();
      }
    }, {
      key: "clear_unreplayed_commands_if_needed",
      value: function clear_unreplayed_commands_if_needed() {
        while (this.command_idx0 < this.command_list.length) {
          this.delete_script_command_by_idx(this.command_list.length - 1);
        }
      }
    }, {
      key: "delete_script_command_by_id",
      value: function delete_script_command_by_id(cmd_id) {
      ...
      key: "delete_script_command_by_idx",
      value: function delete_script_command_by_idx(idx) {
        var elem, elem_and_cmd, orphan, pops;
        elem_and_cmd = this.command_list.splice(idx, 1)[0]; //alert("about to delete: " + elem_and_cmd.cmd.str)
      ...
      key: "update_script_buttons",
      value: function update_script_buttons() {
      ...
      key: "is_proposed",
      value: function is_proposed() {
        return this.proposed_verb || this.proposed_set || this.proposed_taxon;
      }
    }, {
      key: "update_command",
      value: function update_command(because) {
      ...
      key: "run_any_immediate_command",
      value: function run_any_immediate_command(because) {
        var ready; //console.log("run_any_immediate_command()", because)
      ...
      key: "perform_current_command",
      value: function perform_current_command(because) {
        var start;
      ...
      key: "perform_any_cleanup",
      value: function perform_any_cleanup(because) {
      ...
      key: "prepare_command",
      value: function prepare_command(cmd) {
        this.command = cmd;

        if (this.nextcommand_prompts_visible || true) {
          // NEEDED BY huviz_test.js
      ...
      key: "ready_to_perform",
      value: function ready_to_perform() {
      ...
      key: "build_verb_form",
      value: function build_verb_form() {
      ...
      key: "add_verb_set",
      value: function add_verb_set(vset) {
      ...
      key: "get_verbs_overridden_by",
      value: function get_verbs_overridden_by(verb_id) {
      ...
      key: "are_non_transient_verbs",
      value: function are_non_transient_verbs() {
        var len_transient; // return whether there are any non-transient verbs engaged

        len_transient = this.transient_verb_engaged != null && 1 || 0;
        return this.engaged_verbs.length > len_transient;
      }
    }, {
      key: "engage_transient_verb_if_needed",
      value: function engage_transient_verb_if_needed(verb_id) {
        if (this.engaged_verbs.length === 0 && !this.are_non_transient_verbs()) {
          return this.engage_verb(verb_id, true);
        }
      }
    }, {
      key: "disengage_transient_verb_if_needed",
      value: function disengage_transient_verb_if_needed() {
      ...
      key: "engage_verb",
      value: function engage_verb(verb_id, _transient) {
      ...
      key: "disengage_verb",
      value: function disengage_verb(verb_id, _transient2) {
      ...
      key: "build_verb_picker",
      value: function build_verb_picker(id, label, alternatives) {
        var _this9 = this;
        ...
        vbctl.on('click', function () {
          return _this9.handle_on_verb_clicked(id, vbctl);
        });
        vbctl.on('mouseenter', function () {
          // tell user what will happen if this verb is clicked
      ...
      key: "handle_on_verb_clicked",
      value: function handle_on_verb_clicked(id, elem) {
        var _this10 = this;

        this.start_working();
        return setTimeout(function () {
          // run asynchronously so @start_working() can get a head start
          return _this10.on_verb_clicked(id, elem);
        });
      }
    }, {
      key: "on_verb_clicked",
      value: function on_verb_clicked(id, elem) {
      ...
      key: "run_script",
      value: function run_script(script) {
      ...
      key: "build_set_picker",
      value: function build_set_picker(label, where) {
        // FIXME populate @the_sets from @huviz.selectable_sets
        where = label != null && this.control_label(label, where) || this.comdiv;
        this.the_sets = {
          // TODO build this automatically from huviz.selectable_sets
      ...
      key: "populate_all_set_docs",
      value: function populate_all_set_docs() {
      ...
      key: "make_sets_proposable",
      value: function make_sets_proposable() {
        var _this11 = this;

        var a_set, id, make_listeners, ref, results;

        make_listeners = function make_listeners(id, a_set) {
          // fat arrow carries this to @
          var set_ctl;
          set_ctl = _this11.set_picker.id_to_elem[id];
          set_ctl.on('mouseenter', function () {
            _this11.proposed_set = a_set;
            return _this11.update_command();
          });
          return set_ctl.on('mouseleave', function () {
            _this11.proposed_set = null;
            return _this11.update_command();
          });
        };
      ...
      key: "handle_on_set_picked",
      value: function handle_on_set_picked(set_id, new_state) {
        var _this12 = this;

        this.start_working();
        return setTimeout(function () {
          // run asynchronously so @start_working() can get a head start
          return _this12.on_set_picked(set_id, new_state);
        });
      }
    }, {
      key: "on_set_picked",
      value: function on_set_picked(set_id, new_state) {
      ...
      key: "disengage_all_sets",
      value: function disengage_all_sets() {
      ...
      key: "on_set_count_update",
      value: function on_set_count_update(set_id, count) {
        return this.set_picker.set_payload(set_id, count);
      }
    }, {
      key: "on_taxon_count_update",
      value: function on_taxon_count_update(taxon_id, count) {
        return this.taxon_picker.set_payload(taxon_id, count);
      }
    }, {
      key: "on_predicate_count_update",
      value: function on_predicate_count_update(pred_lid, count) {
        return this.predicate_picker.set_payload(pred_lid, count);
      }
    }, {
      key: "clear_set_picker",
      value: function clear_set_picker() {
  ...
  CommandController.prototype.auto_change_verb_tests = {
    ...
    choose: function choose(node) {
      if (node.chosen != null) {
        return 'unchoose';
      }
    },
    unchoose: function unchoose(node, engagedVerb) {
      if (node.chosen == null) {
        return 'choose' || engagedVerb;
      }
    },
    wander: function wander(node) {
      if (node.chosen != null) {
        return 'wander';
      }
    },
    ...
    unlabel: function unlabel(node) {
      if (!node.labelled) {
        return 'label';
      }
    },
    unpin: function unpin(node) {
      if (!node.fixed) {
        return 'pin';
      }
    },
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).CommandController = CommandController;
"use strict";
...
angliciser = require('angliciser').angliciser; //gvcl = require('gvcl') #.GVCL

GCLTest =
/*#__PURE__*/
function () {
  function GCLTest(runner, spec1) {
    _classCallCheck(this, GCLTest);
  ...
  _createClass(GCLTest, [{
    ...
    value: function perform() {
      ...
      ref1 = (ref = this.spec.expectations) != null ? ref : []; // should the expections be checked in a callback?
...
function () {
  ...
  function GCLTestSuite(huviz, suite) {
    _classCallCheck(this, GCLTestSuite);
  ...
  _createClass(GCLTestSuite, [{
    key: "emit",
    value: function emit(txt, id) {
...
GraphCommand = function () {
  ...
  function () {
    ...
    function GraphCommand(huviz, args_or_str) {
      _classCallCheck(this, GraphCommand);
    ...
    _createClass(GraphCommand, [{
      key: "get_node",
      value: function get_node(node_spec) {
        var abbr, id, id_parts, msg, node, prefix, ref, term, tried; // REVIEW this method needs attention
        ...
        if (!node) {
          msg = "node with id = ".concat(term, " not found among ").concat(this.huviz.nodes.length, " nodes: ").concat(tried);
          console.warn(msg);
          throw new Error(msg);
        }
      ...
      value: function get_nodes() {
        ...
        if (this.sets) {
          ref3 = this.sets; // set might be a SortedSet instance or a_set_id string
      ...
      value: function get_methods() {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          if (method) {
            method.build_callback = this.huviz["".concat(verb, "__build_callback")];
            method.callback = this.huviz["".concat(verb, "__atLast")];
            method.atFirst = this.huviz["".concat(verb, "__atFirst")];
            methods.push(method);
          } else {
      ...
      key: "get_predicate_methods",
      value: function get_predicate_methods() {
        var i, len, method, methods, msg, ref, verb;
        methods = [];
        ref = this.verbs;
      ...
      key: "regarding_required",
      value: function regarding_required() {
      ...
      value: function execute() {
        ...
        console.log("%c".concat(this.str), "color:blue;font-size:1.5em;", "on ".concat(nodes.length, " nodes"));

        errorHandler = function errorHandler(err_arg) {
        ...
        if (regarding_required) {
          ...
          // FIXME not very general, but it appears to be the sole exception
          this.huviz.load_with(this.data_uri, this.with_ontologies);
          console.log("load data_uri has returned");
        } else {
          ref1 = this.get_methods(); // find the methods on huviz which implement each verb
      ...
      key: "get_pretty_verbs",
      value: function get_pretty_verbs() {
      ...
      value: function update_str() {
        ...
        this.verb_phrase = '';
        this.noun_phrase = '';
        this.noun_phrase_ready = false; //@object_phrase = null
        ...
        if (this.sets != null) {
          setLabels = [];
          ref = this.sets; // either a list of SortedSets or their ids
          ...
          more = "the ".concat(more, " set") + (this.sets.length > 1 && 's' || '');
          this.object_phrase = more; //if @object_phrase?
        ...
        if (regarding_phrase) {
          ...
          this.suffix_phrase += " at ".concat(this.polar_coords.degrees.toFixed(0), " degrees");
          this.suffix_phrase += " and range ".concat(this.polar_coords.range.toFixed(2), " .");
        } else {
          this.suffix_phrase += ' .';
        }

        cmd_str += this.suffix_phrase; //cmd_str += " ."
...
function () {
  function GraphCommandLanguageCtrl(huviz) {
    _classCallCheck(this, GraphCommandLanguageCtrl);
  ...
  _createClass(GraphCommandLanguageCtrl, [{
    key: "run",
    value: function run(script, callback) {
      var retval;
      this.huviz.before_running_command(this); //console.debug("script: ",script)
      ...
      if (script instanceof GraphCommand) {
        ...
        this.commands = script.split(';'); //@gvcl_script = new GVCL(script)
      ...
      retval = this.execute(callback); //console.log "commands:"
    ...
    key: "run_one",
    value: function run_one(cmd_spec) {
      var cmd;
    ...
    value: function execute(callback) {
      ...
      var cmd_spec, i, len, ref, _run_once;

      if (this.commands.length > 0 && typeof this.commands[0] === 'string' && this.commands[0].match(/^load /)) {
        //console.log("initial execute", @commands)
        this.run_one(this.commands.shift()); //setTimeout @execute, 2000

        _run_once = function run_once() {
          document.removeEventListener('dataset-loaded', _run_once);
          return _this2.execute();
        };

        document.addEventListener('dataset-loaded', _run_once);
        return;
      }
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).GraphCommandLanguageCtrl = GraphCommandLanguageCtrl;
(typeof exports !== "undefined" && exports !== null ? exports : void 0).GraphCommand = GraphCommand;
(typeof exports !== "undefined" && exports !== null ? exports : void 0).GCLTest = GCLTest;
(typeof exports !== "undefined" && exports !== null ? exports : void 0).GCLTestSuite = GCLTestSuite;
"use strict";
...
GreenerTurtle = function () {
  ...
  function () {
    function GreenerTurtle() {
      _classCallCheck(this, GreenerTurtle);
    }

    _createClass(GreenerTurtle, [{
      key: "parse",
      value: function parse(data, type) {
        var G;
  ...
  obj_has_type = function obj_has_type(obj, typ) {
    return obj.type === typ;
  };

  RDF_object = "http://www.w3.org/1999/02/22-rdf-syntax-ns#object";

  build_indices = function build_indices(graph) {
    var obj, oi, p, predicate, results, subj, subj_id; //console.log("SUBJ",graph.subjects);
    ...
    for (subj_id in graph.subjects) {
      ...
      results.push(function () {
        var results1; //console.log('  s =',subj,subj.predicates);

        results1 = [];

        for (p in subj.predicates) {
          predicate = subj.predicates[p]; //console.log('    p =',predicate.objects.length,p);
          ...
          results1.push(function () {
            ...
            while (oi < predicate.objects.length) {
              obj = predicate.objects[oi]; //console.log(obj);
  ...
  get_incoming_predicates = function get_incoming_predicates(subj) {
    var resp;
    resp = this.oid_2_id_p[subj.id] || []; //console.log("get_incoming_predicates(",subj.id,")  ===>",resp);

    return resp;
  };

  count_subjects = function count_subjects(graph) {
    var results, s;
    graph.num_subj = 0;
    results = [];
...
var BASE10,
    ...
    colorlog,
    convert,
    default_node_radius_policy,
    dist_lt,
    distance,
    escapeHtml,
    gcl,
    getPrefixedTypeSignature,
    getTypeSignature,
    has_predicate_value,
    has_type,
    hash,
...
gcl = require('graphcommandlanguage'); //asyncLoop = require('asynchronizer').asyncLoop

CommandController = require('gclui').CommandController;
EditController = require('editui').EditController; //FiniteStateMachine = require('fsm').FiniteStateMachine
...
colorlog = function colorlog(msg, color, size) {
  if (color == null) {
    color = "red";
  }
  ...
  return console.log("%c".concat(msg), "color:".concat(color, ";font-size:").concat(size, ";"));
};

unpad_md = function unpad_md(txt, pad) {
  var in_lines, j, len1, line, out, out_lines; // Purpose:
...
dist_lt = function dist_lt(mouse, d, thresh) {
  var x, y;
  x = mouse[0] - d.x;
  y = mouse[1] - d.y;
...
hash = function hash(str) {
  var hsh, i; // https://github.com/darkskyapp/string-hash/blob/master/index.js
...
convert = function convert(src, srctable, desttable) {
  var destlen, i, numlen, q, r, res, srclen, val; // convert.js
  // http://rot47.net
  // Dr Zhihua Lai

  srclen = srctable.length;
  destlen = desttable.length; // first convert to base 10
...
int_to_base = function int_to_base(intgr) {
  return convert("" + intgr, BASE10, BASE57);
};

synthIdFor = function synthIdFor(str) {
...
_linearize = function linearize(msgRecipient, streamoid) {
  ...
  if (streamoid.idx === 0) {
    ...
    recurse = function recurse() {
      return _linearize(msgRecipient, streamoid);
    };
...
ident = function ident(data) {
  return data;
};

unique_id = function unique_id(prefix) {
  if (prefix == null) {
    prefix = 'uid_';
  }
...
sel_to_id = function sel_to_id(selector) {
...
getPrefixedTypeSignature = function getPrefixedTypeSignature(typeUri) {
  ...
  for (prefix in typeSigRE) {
    ...
    if (match) {
      return "".concat(prefix, "__").concat(match[1]);
    }
  }
};

getTypeSignature = function getTypeSignature(typeUri) {
  var typeSig;
...
id_escape = function id_escape(an_id) {
  var retval;
...
if (true) {
  node_radius_policies = {
    "node radius by links": function nodeRadiusByLinks(d) {
    ...
    "equal dots": function equalDots(d) {
  ...
  has_type = function has_type(subject, typ) {
    return has_predicate_value(subject, RDF_type, typ);
  };

  has_predicate_value = function has_predicate_value(subject, predicate, value) {
    var obj, objs, oi, pre;
...
function () {
  function SettingsWidget(huviz, inputElem1, state) {
    _classCallCheck(this, SettingsWidget);
...
UsernameWidget = function () {
  var UsernameWidget =
  /*#__PURE__*/
  function (_SettingsWidget) {
    _inherits(UsernameWidget, _SettingsWidget);
    ...
    function UsernameWidget() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(UsernameWidget).apply(this, arguments));

      _this.wrap("<div id=\"".concat(_this.id //  style="border:2px solid; padding:2px
      , "\" class=\"geo_input_wrap\"></div>")); //@inputElem.setAttribute('style','border:none')


      _this.widgetJQElem = $('#' + _this.id);

      _this.widgetJQElem.prepend("<i class=\"userIcon fa fa-user-alt\"></i><i class=\"stateIcon fa fa-question\"></i>");

      _this.stateIconJQElem = _this.widgetJQElem.find('.stateIcon');
      _this.userIconJQElem = _this.widgetJQElem.find('.userIcon');

      _this.set_state('empty');
  ...
  UsernameWidget.prototype.state_to_state_icon = {
    bad: 'fa-times',
    // the username has been tried and failed last use
    good: 'fa-check',
    // the username has been tried and succeeded last use
    untried: 'fa-question',
    // a username has been provided but not yet tried
    trying: 'fa-spinner fa-pulse',
    // performing a lookup with a username which might be bad or good
    empty: 'fa-ellipsis-h',
    // no username present
...
GeoUserNameWidget =
/*#__PURE__*/
function (_UsernameWidget) {
  _inherits(GeoUserNameWidget, _UsernameWidget);

  function GeoUserNameWidget() {
    var _this2;

    _classCallCheck(this, GeoUserNameWidget);

    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(GeoUserNameWidget).apply(this, arguments));

    _this2.stateIconJQElem.on('click', _this2.huviz.show_geonames_instructions);

    _this2.userIconJQElem.on('click', _this2.huviz.show_geonames_instructions);
...
Huviz = function () {
  ...
  function () {
    _createClass(Huviz, [{
      key: "how_heavy_are",
      value: function how_heavy_are(n, label, cb) {
        ...
        for (m = j = 1, ref = n; 1 <= ref ? j <= ref : j >= ref; m = 1 <= ref ? ++j : --j) {
          retval = cb.call(this, n); //console.log(retval)
        ...
        memories.push({});
        memories.push({});
        var _memories = memories;

        var _memories2 = _slicedToArray(_memories, 4);
        ...
        before.what = 'before';
        after.what = 'after';
        diff.what = 'diff'; //console.log(per)
      ...
      key: "compose_object_from_defaults_and_incoming",
      value: function compose_object_from_defaults_and_incoming(defs, incoming) {
        // Purpose:
      ...
      key: "gen_dialog_html",
      value: function gen_dialog_html(contents, id, in_args) {
        var args;
        args = this.compose_object_from_defaults_and_incoming(this.default_dialog_args, in_args); //args = Object.assign(default_args, in_args)

        return "<div id=\"".concat(id, "\" class=\"").concat(args.classes, " ").concat(args.extraClasses, "\"\n    style=\"display:block;top:").concat(args.top, "px;left:").concat(args.left, "px;max-width:").concat(args.width, "px;max-height:").concat(args.height, "px\">\n  <div class=\"header\" style=\"background-color:").concat(args.head_bg_color, ";").concat(args.style, "\">\n    <button class=\"close_node_details\" title=\"Close\"><i class=\"far fa-window-close\"></i></button>\n  </div>\n  ").concat(contents // """ for emacs coffeescript mode
        , "\n</div>");
      }
    }, {
      key: "make_dialog",
      value: function make_dialog(content_html, id, args) {
        var elem;
      ...
      key: "destroy_box",
      value: function destroy_box(e) {
        var box;
        box = e.currentTarget.offsetParent;
        return $(box).remove();
      }
    }, {
      key: "make_markdown_dialog",
      value: function make_markdown_dialog(markdown, id, args) {
        if (args == null) {
          args = {};
        }
      ...
      key: "unique_id",
      value: function unique_id(prefix) {
        if (prefix == null) {
          prefix = 'uid_';
        }
      ...
      key: "change_sort_order",
      value: function change_sort_order(array, cmp) {
        array.__current_sort_order = cmp;
        return array.sort(array.__current_sort_order);
      }
    }, {
      key: "isArray",
      value: function isArray(thing) {
        return Object.prototype.toString.call(thing) === "[object Array]";
      }
    }, {
      key: "cmp_on_name",
      value: function cmp_on_name(a, b) {
        if (a.name === b.name) {
          return 0;
        }
      ...
      key: "binary_search_on",
      value: function binary_search_on(sorted_array, sought, cmp, ret_ins_idx) {
        var bot, c, mid, seeking, top; // return -1 or the idx of sought in sorted_array
      ...
      key: "roughSizeOfObject",
      value: function roughSizeOfObject(object) {
        var bytes, i, objectList, stack, value; // http://stackoverflow.com/questions/1248302/javascript-object-size
      ...
      key: "move_node_to_point",
      value: function move_node_to_point(node, point) {
        node.x = point[0];
        return node.y = point[1];
      }
    }, {
      key: "click_node",
      value: function click_node(node_or_id) {
        var evt, node; // motivated by testing. Should this also be used by normal click handling?
      ...
      key: "click_verb",
      value: function click_verb(id) {
        var verbs;
        verbs = $("#verb-".concat(id));

        if (!verbs.length) {
          throw new Error("verb '".concat(id, "' not found"));
        }
      ...
      value: function click_set(id) {
        ...
        if (!sets.length) {
          throw new Error("set '".concat(id, "' not found using selector: '").concat(sel, "'"));
        }
      ...
      key: "click_predicate",
      value: function click_predicate(id) {
        this.gclui.predicate_picker.handle_click(id);
        return this;
      }
    }, {
      key: "click_taxon",
      value: function click_taxon(id) {
        $("#".concat(id)).trigger("click");
        return this;
      }
    }, {
      key: "like_string",
      value: function like_string(str) {
        // Ideally we'd trigger an actual 'input' event but that is not possible
        //$(".like_input").val(str)
        this.gclui.like_input.val(str);
        this.gclui.handle_like_input(); //debugger if @DEBUG and str is ""

        return this;
      }
    }, {
      key: "toggle_expander",
      value: function toggle_expander(id) {
        this.topJQElem.find("#".concat(id, " span.expander:first")).trigger("click");
        return this;
      }
    }, {
      key: "doit",
      ...
      key: "make_cursor_text_while_dragging",
      value: function make_cursor_text_while_dragging(action) {
        var drag_or_drop;
        ...
        return "".concat(this.human_term[drag_or_drop] || drag_or_drop, " to ").concat(this.human_term[action] || action);
      }
    }, {
      key: "get_mouse_point",
      value: function get_mouse_point(d3_event) {
        if (d3_event == null) {
      ...
      key: "should_start_dragging",
      value: function should_start_dragging() {
      ...
      value: function mousemove() {
        ...
        if (this.rightClickHold) {
          ...
          if (this.focused_node) {
            the_node = $("#".concat(this.focused_node.lid));
        ...
        if (this.peeking_node != null) {
          ...
          if (this.focused_node != null && this.focused_node !== this.peeking_node) {
            ...
            ref1 = this.peeking_node.links_shown; //console.log "   PEEKING at edge between" + @peeking_node.id + " and " + @focused_node.id
      ...
      value: function mouseup() {
        ...
        if (d3.event.button === 2) {
          // Right click event so don't alter selected state
          this.text_cursor["continue"]();
          this.text_cursor.set_text("Select");

          if (this.focused_node) {
            $("#".concat(this.focused_node.lid)).removeClass("temp");
          }
        ...
        if (this.dragging) {
          ...
          if (this.in_discard_dropzone(this.dragging)) {
            ...
            // TODO rename to shelve_dropzone
            this.run_verb_on_object('shelve', this.dragging); // @unselect(@dragging) # this might be confusing
        ...
        if (this.editui.is_state('connecting') && this.focused_node && this.editui.object_datatype_is_literal) {
          this.editui.set_subject_node(this.focused_node); //console.log("edit mode and focused note and editui is literal")
        ...
        if (this.focused_node) {
          // and @focused_node.state is @graphed_set
        ...
        drag_dist = distance(point, this.mousedown_point); //if drag_dist > @drag_dist_threshold
      ...
      key: "log_mouse_activity",
      value: function log_mouse_activity(label) {
        return console.log(label, "\n  dragging", this.dragging, "\n  mousedown_point:", this.mousedown_point, "\n  @focused_node:", this.focused_node);
      }
    }, {
      key: "mouseright",
      value: function mouseright() {
      ...
      key: "render_node_info_box",
      value: function render_node_info_box() {
        ...
        if (this.focused_node.links_from.length > 0) {
          ...
          for (p = 0, len3 = ref1.length; p < len3; p++) {
            ...
            var _this$render_target_f = this.render_target_for_display(link_from.target);

            var _this$render_target_f2 = _slicedToArray(_this$render_target_f, 2);

            target_prefix = _this$render_target_f2[0];
            target = _this$render_target_f2[1];
            node_out_links = node_out_links + "<li><i class='fas fa-long-arrow-alt-right'></i>\n  <a href='".concat(link_from.predicate.id, "' target='blank'>").concat(link_from.predicate.lid, "</a>\n  ").concat(target_prefix, " ").concat(target // """
            , "\n</li>");
          }
        ...
        if (this.focused_node._colors) {
          ...
          for (z = 0, len4 = ref2.length; z < len4; z++) {
            color = ref2[z];
            color_headers = color_headers + "<div class='subHeader' style='background-color: ".concat(color, "; width: ").concat(width, "%;'></div>");
          }
        }
        ...
        if (this.focused_node) {
          ...
          node_info = "<p class='id_display'><span class='label'>id:</span> ".concat(id_display, "</p>\n<p><span class='label'>name:</span> ").concat(names_all_langs, "</p>\n<p><span class='label'>type(s):</span> ").concat(this.focused_node.type, " ").concat(other_types, "</p>\n<p><span class='label'>Links To:</span> ").concat(this.focused_node.links_to.length, " <br>\n  <span class='label'>Links From:</span> ").concat(this.focused_node.links_from.length, "</p>\n  ").concat(note, "\n  ").concat(node_out_links // """
          );
          this.make_dialog(node_info, this.unique_id(this.focused_node.lid + '__'), dialogArgs);
        }
      }
    }, {
      key: "create_link_if_url",
      value: function create_link_if_url(possible_link) {
        var target, url_check;
        url_check = possible_link.substring(0, 4);

        if (url_check === "http") {
          return target = "<a href='".concat(possible_link, "' target='blank'>").concat(possible_link, "</a>");
        } else {
          return target = possible_link;
        }
      }
    }, {
      key: "render_target_for_display",
      value: function render_target_for_display(node) {
        ...
        if (node.isLiteral) {
          ...
          if (showBlock) {
            return [colon, "<blockquote title=\"".concat(typeCURIE, "\">").concat(node.name, "</blockquote>")];
          } else {
            return [colon, "<code title=\"".concat(typeCURIE, "\">").concat(node.name, "</code>")];
          }
        } else {
      ...
      key: "perform_current_command",
      value: function perform_current_command(node) {
        var cmd;
      ...
      key: "run_command",
      value: function run_command(cmd, callback) {
      ...
      value: function updateWindow() {
        ...
        $("".concat(instance_container, " .graph_title_set")).css("width", this.width);
      ...
      key: "draw_circle",
      value: function draw_circle(cx, cy, radius, strclr, filclr, start_angle, end_angle, special_focus) {
        var incl_cntr;
        ...
        if (special_focus) {
          // true if this is a wander or walk highlighted node
          this.ctx.beginPath();
          radius = radius / 2;
      ...
      key: "draw_round_img",
      value: function draw_round_img(cx, cy, radius, strclr, filclr, special_focus, imageData, url) {
      ...
      key: "draw_triangle",
      value: function draw_triangle(x, y, color, x1, y1, x2, y2) {
        this.ctx.beginPath();
        this.ctx.moveTo(x, y);
      ...
      key: "draw_pie",
      value: function draw_pie(cx, cy, radius, strclr, filclrs, special_focus) {
      ...
      key: "draw_line",
      value: function draw_line(x1, y1, x2, y2, clr) {
      ...
      key: "draw_curvedline",
      value: function draw_curvedline(x1, y1, x2, y2, sway_inc, clr, num_contexts, line_width, edge, directional_edge) {
        ...
        check_range = function check_range(val, name) {
          var range;
        ...
        this.ctx.moveTo(x1, y1);
        this.ctx.quadraticCurveTo(xctrl, yctrl, x2, y2); //@ctx.closePath()
      ...
      key: "draw_disconnect_dropzone",
      value: function draw_disconnect_dropzone() {
        this.ctx.save();
      ...
      key: "draw_discard_dropzone",
      value: function draw_discard_dropzone() {
        this.ctx.save();
      ...
      key: "in_disconnect_dropzone",
      value: function in_disconnect_dropzone(node) {
        var dist; // is it within the RIM of the disconnect circle?

        dist = distance(node, this.lariat_center);
        return this.graph_radius * 0.9 < dist && this.graph_radius * 1.1 > dist;
      }
    }, {
      key: "in_discard_dropzone",
      value: function in_discard_dropzone(node) {
        var dist; // is it ANYWHERE within the circle?
      ...
      value: function init_sets() {
        ...
        this.nodes.docs = "".concat(this.nodes.label, " nodes are in this set, regardless of state.");
        this.all_set = this.nodes;
        this.embryonic_set = SortedSet().named("embryo").sort_on("id").isFlag();
        this.embryonic_set.docs = "Nodes which are not yet complete are 'embryonic' and not yet in '".concat(this.all_set.label, "'.  Nodes need to have a class and a label to no longer be embryonic.");
        this.chosen_set = SortedSet().named("chosen").sort_on("id").isFlag().labelled(this.human_term.chosen).sub_of(this.all_set);
        this.chosen_set.docs = "Nodes which the user has specifically '".concat(this.chosen_set.label, "' by either dragging them into the graph from the surrounding green 'shelf'. '").concat(this.chosen_set.label, "' nodes can drag other nodes into the graph if the others are ").concat(this.human_term.hidden, " or ").concat(this.human_term.shelved, " but not if they are ").concat(this.human_term.discarded, ".");
        ...
        this.selected_set.docs = "Nodes which have been '".concat(this.selected_set.label, "' using the class picker, ie which are highlighted and a little larger.");
        ...
        this.shelved_set.docs = "Nodes which are '".concat(this.shelved_set.label, "' on the green surrounding 'shelf', either because they have been dragged there or released back to there when the node which pulled them into the graph was '").concat(this.human_term.unchosen, ".");
        ...
        this.discarded_set.docs = "Nodes which have been '".concat(this.discarded_set.label, "' by being dragged into the red 'discard bin' in the bottom right corner. '").concat(this.discarded_set.label, "' nodes are not pulled into the graph when nodes they are connected to become '").concat(this.chosen_set.label, "'.");
        this.hidden_set = SortedSet().named("hidden").sort_on("id").labelled(this.human_term.hidden).sub_of(this.all_set).isState();
        this.hidden_set.docs = "Nodes which are '".concat(this.hidden_set.label, "' but can be pulled into the graph by other nodes when those become '").concat(this.human_term.chosen, "'.");
        ...
        this.graphed_set.docs = "Nodes which are included in the central graph either by having been '".concat(this.human_term.chosen, "' themselves or which are pulled into the graph by those which have been.");
        ...
        this.pinned_set.docs = "Nodes which are '".concat(this.pinned_set.label, "' to the canvas as a result of being dragged and dropped while already being '").concat(this.human_term.graphed, "'. ").concat(this.pinned_set.label, " nodes can be ").concat(this.human_term.unpinned, " by dragging them from their ").concat(this.pinned_set.label, " location.");
        ...
        this.context_set.docs = "The set of quad contexts."; // TODO make selectable_sets drive gclui.build_set_picker
      ...
      key: "get_set_by_id",
      value: function get_set_by_id(setId) {
        setId = setId === 'fixed' && 'pinned' || setId; // because pinned uses fixed as its 'name'

        return this[setId + '_set'];
      }
    }, {
      key: "update_all_counts",
      value: function update_all_counts() {
        return this.update_set_counts();
      } //@update_predicate_counts()

    }, {
      key: "update_predicate_counts",
      value: function update_predicate_counts() {
      ...
      key: "update_set_counts",
      value: function update_set_counts() {
      ...
      value: function summarize_taxonomy() {
        ...
        for (id in ref) {
          taxon = ref[id];
          out += "".concat(id, ": ").concat(taxon.state, "\n");
          tree[id] = taxon.state;
        }
      ...
      key: "regenerate_english",
      value: function regenerate_english() {
        var root;
        root = 'Thing';
        ...
        if (this.taxonomy[root] != null) {
          ...
          console.log("not regenerating english because no taxonomy[".concat(root, "]"));
        }
      }
    }, {
      key: "get_or_create_taxon",
      value: function get_or_create_taxon(taxon_id) {
      ...
      key: "update_labels_on_pickers",
      value: function update_labels_on_pickers() {
        var ref, results1, term_id, term_label;
        ref = this.ontology.label;
        results1 = [];

        for (term_id in ref) {
          term_label = ref[term_id]; // a label might be for a taxon or a predicate, so we must sort out which
      ...
      key: "toggle_taxon",
      value: function toggle_taxon(id, hier, callback) {
        var ref;
        ...
        this.topJQElem.find("#".concat(id)).trigger("click");
      ...
      key: "perform_tasks_after_dataset_loaded",
      value: function perform_tasks_after_dataset_loaded() {
      ...
      value: function reset_graph() {
        ...
        d3.select("".concat(this.args.huviz_top_sel, " .link")).remove();
        d3.select("".concat(this.args.huviz_top_sel, " .node")).remove();
        d3.select("".concat(this.args.huviz_top_sel, " .lariat")).remove();
        this.node = this.svg.selectAll("".concat(this.args.huviz_top_sel, " .node"));
        this.link = this.svg.selectAll("".concat(this.args.huviz_top_sel // looks bogus, see @link assignment below
        , " .link"));
        this.lariat = this.svg.selectAll("".concat(this.args.huviz_top_sel, " .lariat"));
      ...
      key: "set_node_radius_policy",
      value: function set_node_radius_policy(evt) {
        var f; // TODO(shawn) remove or replace this whole method
        ...
        if (_typeof(f) === _typeof("str")) {
          return this.node_radius_policy = node_radius_policies[f];
        } else if (_typeof(f) === _typeof(this.set_node_radius_policy)) {
      ...
      key: "DEPRECATED_init_node_radius_policy",
      value: function DEPRECATED_init_node_radius_policy() {
      ...
      key: "calc_node_radius",
      value: function calc_node_radius(d) {
      ...
      key: "names_in_edges",
      value: function names_in_edges(set) {
        var out;
        out = [];
      ...
      key: "dump_details",
      value: function dump_details(node) {
      ...
      key: "find_node_or_edge_closest_to_pointer",
      value: function find_node_or_edge_closest_to_pointer() {
        var _this3 = this;
        ...
        this.nodes.forEach(function (d, i) {
          var n_dist;
          n_dist = distance(d.fisheye || d, _this3.last_mouse_pos); //console.log(d)
          ...
          if (!(seeking === 'object_node' && _this3.dragging && _this3.dragging.id === d.id)) {
        ...
        this.links_set.forEach(function (e, i) {
          ...
          if (e.handle != null) {
            e_dist = distance(e.handle, _this3.last_mouse_pos);
        ...
        if (new_focused_edge) {
          // the mouse is closer to an edge than a node
          new_focused_node = null;
          seeking = null;
        }
      ...
      key: "set_focused_node",
      value: function set_focused_node(node) {
        // node might be null
        var svg_node;
      ...
      key: "set_focused_edge",
      value: function set_focused_edge(new_focused_edge) {
      ...
      key: "set_proposed_edge",
      value: function set_proposed_edge(new_proposed_edge) {
      ...
      key: "install_update_pointer_togglers",
      value: function install_update_pointer_togglers() {
        var _this4 = this;

        console.warn("the update_pointer_togglers are being called too often");
        d3.select("#huvis_controls").on("mouseover", function () {
          _this4.update_pointer = false;
          return _this4.text_cursor.pause("default");
        }); //console.log "update_pointer: #{@update_pointer}"

        return d3.select("#huvis_controls").on("mouseout", function () {
          _this4.update_pointer = true;
          return _this4.text_cursor["continue"]();
        });
      } //console.log "update_pointer: #{@update_pointer}"

    }, {
      key: "DEPRECATED_adjust_cursor",
      value: function DEPRECATED_adjust_cursor() {
        var next; // http://css-tricks.com/almanac/properties/c/cursor/
      ...
      key: "set_cursor_for_verbs",
      value: function set_cursor_for_verbs(verbs) {
        var text, verb;
      ...
      key: "auto_change_verb",
      value: function auto_change_verb() {
        if (this.focused_node) {
          return this.gclui.auto_change_verb_if_warranted(this.focused_node);
        }
      }
    }, {
      key: "get_focused_node_and_its_state",
      value: function get_focused_node_and_its_state() {
        var focused, retval;
      ...
      key: "on_tick_change_current_command_if_warranted",
      value: function on_tick_change_current_command_if_warranted() {
        var nodes; // It is warranted if we are hovering over nodes and the last state and this stat differ.
      ...
      key: "position_nodes_by_force",
      value: function position_nodes_by_force() {
        var _this5 = this;
        ...
        return this.nodes.forEach(function (node, i) {
          return _this5.reposition_node_by_force(node, only_move_subject);
        });
      }
    }, {
      key: "reposition_node_by_force",
      value: function reposition_node_by_force(node, only_move_subject) {
      ...
      key: "apply_fisheye",
      value: function apply_fisheye() {
        var _this6 = this;

        this.links_set.forEach(function (e) {
          if (!e.target.fisheye) {
            return e.target.fisheye = _this6.fisheye(e.target);
          }
        });
      ...
      key: "show_message_once",
      value: function show_message_once(msg, alert_too) {
      ...
      key: "draw_edges_from",
      value: function draw_edges_from(node) {
        var draw_n_n, e, edge_width, edges_between, j, len1, line_width, msg, n_n, num_edges, ref, results1, sway;
        num_edges = node.links_to.length; //@show_message_once "draw_edges_from(#{node.id}) "+ num_edges
        ...
        for (j = 0, len1 = ref.length; j < len1; j++) {
          ...
          if (e.source.embryo) {
            msg += "source ".concat(e.source.name, " is embryo ").concat(e.source.id, "; ");
            msg += e.id + " ";
          }

          if (e.target.embryo) {
            msg += "target ".concat(e.target.name, " is embryo ").concat(e.target.id);
          }
        ...
        for (n_n in draw_n_n) {
          ...
          results1.push(function () {
            ...
            for (o = 0, len2 = edges_between.length; o < len2; o++) {
              e = edges_between[o]; //console.log e
              ...
              line_width = line_width + this.line_edge_weight * e.contexts.length; //@show_message_once("will draw line() n_n:#{n_n} e.id:#{e.id}")
      ...
      key: "draw_walk_edge_from",
      value: function draw_walk_edge_from(node, edge, sway) {
        var directional_edge, e; //if this line from path node to path node then add black highlight
      ...
      value: function draw_edges() {
        ...
        if (this.use_canvas) {
          this.graphed_set.forEach(function (node, i) {
            return _this7.draw_edges_from(node);
          });
        }
        ...
        if (this.use_webgl) {
          ...
          this.links_set.forEach(function (e) {
            ...
            if (!e.gl) {
              ...
              _this7.add_webgl_line(e);
            }

            l = e.gl; //	  if (e.source.fisheye.x != e.target.fisheye.x &&
            //	      e.source.fisheye.y != e.target.fisheye.y){
            //	      alert(e.id + " edge has a length");
            //	  }

            _this7.mv_line(l, e.source.fisheye.x, e.source.fisheye.y, e.target.fisheye.x, e.target.fisheye.y);

            return _this7.dump_line(l);
          });
        }
      ...
      key: "draw_nodes_in_set",
      value: function draw_nodes_in_set(set, radius, center) {
        var _this8 = this;

        var cx, cy, num; // cx and cy are local here TODO(smurp) rename cx and cy

        cx = center[0];
        cy = center[1];
        num = set.length;
        return set.forEach(function (node, i) {
          var filclrs, rad, start; //clockwise = false
          // 0 or 1 starts at 6, 0.5 starts at 12, 0.75 starts at 9, 0.25 starts at 3

          start = 1 - nodeOrderAngle;

          if (_this8.display_shelf_clockwise) {
            rad = tau * (start - i / num);
          } else {
            rad = tau * (i / num + start);
          }
          ...
          node.fisheye = _this8.fisheye(node);

          if (_this8.use_canvas) {
            filclrs = _this8.get_node_color_or_color_list(node, renderStyles.nodeHighlightOutline);

            _this8.draw_pie(node.fisheye.x, node.fisheye.y, _this8.calc_node_radius(node), node.color || "yellow", filclrs);
          }

          if (_this8.use_webgl) {
            return _this8.mv_node(node.gl, node.fisheye.x, node.fisheye.y);
          }
        });
      }
    }, {
      key: "draw_discards",
      value: function draw_discards() {
        return this.draw_nodes_in_set(this.discarded_set, this.discard_radius, this.discard_center);
      }
    }, {
      key: "draw_shelf",
      value: function draw_shelf() {
        return this.draw_nodes_in_set(this.shelved_set, this.graph_radius, this.lariat_center);
      }
    }, {
      key: "draw_nodes",
      value: function draw_nodes() {
        var _this9 = this;
        ...
        if (this.use_canvas || this.use_webgl) {
          return this.graphed_set.forEach(function (d, i) {
            ...
            d.fisheye = _this9.fisheye(d); //console.log d.name.NOLANG

            if (_this9.use_canvas) {
              node_radius = _this9.calc_node_radius(d);
              stroke_color = d.color || 'yellow';

              if (d.chosen != null) {
                stroke_color = renderStyles.nodeHighlightOutline; // if the node d is in the @walked_set it needs special_focus
              ...
              if (node_display_type === 'pills') {
                ...
                filclr = _this9.get_node_color_or_color_list(d);
                rndng = 1;
                x = d.fisheye.x;
                y = d.fisheye.y;

                _this9.rounded_rectangle(x, y, pill_width, pill_height, rndng, stroke_color, filclr);
              } else if (_this9.show_images_in_nodes && (imgUrl = d.__thumbnail || _this9.args.default_node_url)) {
                try {
                  imageData = _this9.get_or_create_round_img(imgUrl);
                } catch (error1) {
                  e = error1;
                  console.error(e);
                }

                _this9.draw_round_img(d.fisheye.x, d.fisheye.y, node_radius, stroke_color, filclr, special_focus, imageData, imgUrl);
              } else {
                _this9.draw_pie(d.fisheye.x, d.fisheye.y, node_radius, stroke_color, _this9.get_node_color_or_color_list(d), special_focus);
              }
            }

            if (_this9.use_webgl) {
              return _this9.mv_node(d.gl, d.fisheye.x, d.fisheye.y);
            }
          });
        }
      }
    }, {
      key: "get_node_color_or_color_list",
      value: function get_node_color_or_color_list(n, default_color) {
      ...
      key: "get_or_create_round_img",
      value: function get_or_create_round_img(url) {
        ...
        if (!(img = this.round_img_cache[url])) {
          ...
          origImage.onload = function () {
            // When image is loaded create a new round image
            var h, w, x, y;
            ctx.beginPath(); // This needs to be half the size of height/width to fill canvas area
      ...
      key: "get_label_attributes",
      value: function get_label_attributes(d) {
        ...
        if (label_length < width_default + 2 * padding) {
          ...
          for (i = j = 0, len1 = text_split.length; j < len1; i = ++j) {
            ...
            if (new_line_length < width_default) {
              //if line length is still less than max
              ...
              if (new_line_width > max_line_length) {
                // remember longest line lengthth
        ...
        font_size = this.label_em; //console.log text
      ...
      key: "should_show_label",
      value: function should_show_label(node) {
      ...
      value: function draw_labels() {
        ...
        if (this.use_canvas || this.use_webgl) {
          ...
          focused_font = "".concat(focused_font_size, "em sans-serif");
          unfocused_font = "".concat(this.label_em, "em sans-serif");
          focused_pill_font = "".concat(this.label_em, "em sans-serif");

          label_node = function label_node(node) {
            ...
            if (!_this10.should_show_label(node)) {
              return;
            }

            ctx = _this10.ctx;
            ctx.textBaseline = "middle"; // perhaps scrolling should happen here
            //if not node_display_type and (node.focused_node or node.focused_edge?)

            if (node.focused_node || node.focused_edge != null) {
              label = _this10.scroll_pretty_name(node);
            ...
            flip_point = _this10.cx;

            if (_this10.discarded_set.has(node)) {
              flip_point = _this10.discard_center[0];
            } else if (_this10.shelved_set.has(node)) {
              flip_point = _this10.lariat_center[0];
            }

            if (!_this10.graphed_set.has(node) && _this10.draw_lariat_labels_rotated) {
              ...
              if (_this10.debug_shelf_angles_and_flipping) {
                if (flip) {
                  //radians < 0
              ...
              if (node_display_type === 'pills') {
                ...
                result = node_font_size !== _this10.label_em;

                if (!node.bub_txt.length || result) {
                  _this10.get_label_attributes(node);
                }
                ...
                radius = 10 * _this10.label_em;
                alpha = 1;
                outline = node.color; // change box edge thickness and fill if node selected
                ...
                _this10.rounded_rectangle(x, y, pill_width, pill_height, radius, fill, outline, alpha);

                ctx.fillStyle = "#000"; // Paint multi-line text
                ...
                if (print_label) {
                  // print last line, or single line if no cuts
      ...
      key: "draw_focused_labels",
      value: function draw_focused_labels() {
        var _this11 = this;
        ...
        highlight_node = function highlight_node(node) {
          ...
          if (node.focused_node || node.focused_edge != null) {
            if (node_display_type === 'pills') {
              ...
              node_font_size = node.bub_txt[4];
              result = node_font_size !== _this11.label_em;

              if (!node.bub_txt.length || result) {
                _this11.get_label_attributes(node);
              }
              ...
              _this11.rounded_rectangle(x, y, pill_width, pill_height, radius, fill, outline, alpha);
              ...
              label = _this11.scroll_pretty_name(node);

              if (node.state.id === "graphed") {
                cart_label = node.pretty_name;
                ctx.measureText(cart_label).width; //forces proper label measurement (?)

                if (_this11.cartouches) {
                  _this11.draw_cartouche(cart_label, focused_font_size, node.fisheye.x, node.fisheye.y);
                }
              }
      ...
      key: "clear_canvas",
      value: function clear_canvas() {
        return this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height);
      }
    }, {
      key: "blank_screen",
      value: function blank_screen() {
        if (this.use_canvas || this.use_webgl) {
          return this.clear_canvas();
        }
      }
    }, {
      key: "should_position_by_packing",
      value: function should_position_by_packing() {
        return !this.show_edges;
      }
    }, {
      key: "position_nodes_by_packing",
      value: function position_nodes_by_packing() {
        var i, n, q, results1; // https://bl.ocks.org/mbostock/3231298
      ...
      key: "position_node_by_packing",
      value: function position_node_by_packing(node) {
      ...
      key: "respect_single_chosen_node",
      value: function respect_single_chosen_node() {
        ...
        ref = this.pinned_set; // Uncenter nodes which are no longer the only chosen node
      ...
      value: function tick(msg) {
        ...
        this.on_tick_change_current_command_if_warranted(); //@update_snippet() // not in use
      ...
      value: function rounded_rectangle(x, y, w, h, radius, fill, stroke, alpha) {
        var b, ctx, r; // http://stackoverflow.com/questions/1255512/how-to-draw-a-rounded-rectangle-on-html-canvas
      ...
      key: "draw_cartouche",
      value: function draw_cartouche(label, focused_font_size, x, y) {
      ...
      key: "draw_edge_labels",
      value: function draw_edge_labels() {
      ...
      key: "draw_edge_label",
      value: function draw_edge_label(edge) {
        var ctx, height, label, width;
        ctx = this.ctx; // TODO the edge label should really come from the pretty name of the predicate
        ...
        if (this.snippet_count_on_edge_labels) {
          if (edge.contexts != null) {
            if (edge.contexts.length) {
              label += " (".concat(edge.contexts.length, ")");
            }
          }
        }
      ...
      key: "show_state_msg",
      value: function show_state_msg(txt) {
        if (false) {
      ...
      key: "svg_restart",
      value: function svg_restart() {
        var nodeEnter; // console.log "svg_restart()"
      ...
      key: "canvas_show_text",
      value: function canvas_show_text(txt, x, y) {
      ...
      key: "pnt2str",
      value: function pnt2str(x, y) {
        return "[" + Math.floor(x) + ", " + Math.floor(y) + "]";
      }
    }, {
      key: "show_pos",
      value: function show_pos(x, y, dx, dy) {
        dx = dx || 0;
        dy = dy || 0;
      ...
      key: "show_line",
      value: function show_line(x0, y0, x1, y1, dx, dy, label) {
        dx = dx || 0;
        dy = dy || 0;
      ...
      key: "add_node_ghosts",
      value: function add_node_ghosts(d) {
        if (this.use_webgl) {
      ...
      key: "add_to",
      value: function add_to(itm, array, cmp) {
        var c; // FIXME should these arrays be SortedSets instead?

        cmp = cmp || array.__current_sort_order || this.cmp_on_id;
        c = this.binary_search_on(array, itm, cmp, true);

        if (_typeof(c) === _typeof(3)) {
          return c;
        }
      ...
      key: "remove_from",
      value: function remove_from(itm, array, cmp) {
        var c;
        cmp = cmp || array.__current_sort_order || this.cmp_on_id;
      ...
      key: "fire_newsubject_event",
      value: function fire_newsubject_event(s) {
      ...
      key: "ensure_predicate_lineage",
      value: function ensure_predicate_lineage(pid) {
        var parent_lid, pred_lid, pred_name; // Ensure that fire_newpredicate_event is run for pid all the way back
      ...
      key: "fire_newpredicate_event",
      value: function fire_newpredicate_event(pred_uri, pred_lid, parent_lid, pred_name) {
      ...
      key: "auto_discover_header",
      value: function auto_discover_header(uri, digestHeaders, sendHeaders) {
        ...
        return $.ajax({
          ...
          beforeSend: function beforeSend(xhr) {
            var j, len1, pair, results1; //console.log(xhr)

            results1 = [];

            for (j = 0, len1 = sendHeaders.length; j < len1; j++) {
              pair = sendHeaders[j]; //xhr.setRequestHeader('X-Test-Header', 'test-value')
      ...
      key: "discovery_triple_ingestor_N3",
      value: function discovery_triple_ingestor_N3(data, textStatus, request, discoArgs) {
        var _this13 = this;

        var parser, quadMunger, quadTester, quad_count; // Purpose:
        ...
        quadTester = discoArgs.quadTester || function (q) {
          return q != null;
        };

        quadMunger = discoArgs.quadMunger || function (q) {
          return [q];
        };
        ...
        return parser.parse(data, function (err, quad, pref) {
          ...
          if (quadTester(quad)) {
            ...
            for (j = 0, len1 = ref.length; j < len1; j++) {
              aQuad = ref[j];
              results1.push(_this13.inject_discovered_quad_for(quad, discoArgs.aUrl));
            }
      ...
      key: "discovery_triple_ingestor_GreenTurtle",
      value: function discovery_triple_ingestor_GreenTurtle(data, textStatus, request, discoArgs) {
        var aQuad, dataset, default_quadTester, frame, graphUri, j, len1, len2, o, obj, pred, pred_id, quad, quadMunger, quadTester, ref, ref1, ref2, ref3, subj_uri; // Purpose:
        //   This is the XHR callback returned by @make_triple_ingestor()
        //   The assumption is that data will be something N3 can parse.
        // Accepts:
        //   discoArgs:
        ...
        default_quadTester = function default_quadTester(q) {
          return q != null;
        };

        quadTester = discoArgs.quadTester || default_quadTester;
      ...
      key: "make_triple_ingestor",
      value: function make_triple_ingestor(discoArgs) {
        var _this14 = this;

        return function (data, textStatus, request) {
          return _this14.discovery_triple_ingestor_GreenTurtle(data, textStatus, request, discoArgs);
        };
      }
    }, {
      key: "discover_labels",
      value: function discover_labels(aUrl) {
        var discoArgs;
        discoArgs = {
          aUrl: aUrl,
          quadTester: function quadTester(quad) {
            var ref;
          ...
          quadMunger: function quadMunger(quad) {
            return [quad];
          },
      ...
      key: "ingest_quads_from",
      value: function ingest_quads_from(uri, success, failure) {
        return $.ajax({
          type: 'GET',
          url: uri,
          success: success,
      ...
      key: "set_setting",
      value: function set_setting(inputName, newVal) {
        var input;
        input = this.topJQElem.find("input[name='".concat(inputName, "']"));
        input.val(newVal);
      ...
      key: "countdown_setting",
      value: function countdown_setting(inputName) {
        var input, newVal;
        input = this.topJQElem.find("input[name='".concat(inputName, "']"));
      ...
      key: "preset_discover_geonames_remaining",
      value: function preset_discover_geonames_remaining() {
      ...
      key: "show_geonames_instructions",
      value: function show_geonames_instructions(params) {
        var args, markdown; //params =
        ...
        if (params != null) {
          if (params.msg != null) {
            markdown += "        \n#### Error:\n<span style=\"color:red\">".concat(params.msg, "</span>");
          }
        }
      ...
      key: "discover_geoname_name",
      value: function discover_geoname_name(aUrl) {
        var _this15 = this;
        ...
        url = "http://api.geonames.org/hierarchyJSON?geonameId=".concat(id, "&username=").concat(userId);
        ...
        if (widget = this.discover_geonames_as__widget) {
          if (widget.state === 'untried') {
            ...
            rem = this.countdown_setting('discover_geonames_remaining'); //console.info('discover_geoname_name() widget.state =', widget.state, "so decrementing remaining (#{rem}) early")
        ...
        $.ajax({
          ...
          error: function error(xhr, status, _error) {
            ...
            if (_error === 'Unauthorized') {
              if (_this15.discover_geonames_as__widget.state !== 'bad') {
                _this15.discover_geonames_as__widget.set_state('bad');

                return _this15.show_geonames_instructions();
              }
            }
          },
          success: function success(json, textStatus, request) {
            ...
            if (json.status) {
              if (_this15.discover_geoname_name_msgs == null) {
                _this15.discover_geoname_name_msgs = {};
              }

              if (json.status.message) {
                msg = "<dt style=\"font-size:.9em;color:red\">".concat(json.status.message, "</dt>") + _this15.discover_geoname_name_instructions;

                if (userId) {
                  msg = "".concat(userId, " ").concat(msg);
                }
              }

              if (!_this15.discover_geoname_name_msgs[msg] || _this15.discover_geoname_name_msgs[msg] && Date.now() - _this15.discover_geoname_name_msgs[msg] > _this15.discover_geoname_name_msgs_threshold_ms) {
                _this15.discover_geoname_name_msgs[msg] = Date.now();

                _this15.make_dialog(msg);
              }
            ...
            if (widget = _this15.discover_geonames_as__widget) {
              ...
              if (state_at_start === 'trying' || state_at_start === 'looking') {
                ...
                if (widget.state === 'trying') {
                  ...
                  _this15.countdown_setting('discover_geonames_remaining');

                  _this15.discover_geonames_as__widget.set_state('looking'); // more remaining, go straight to looking

                }

                if (widget.state === 'looking') {
                  if (_this15.discover_geonames_remaining > 0) {
                    // trigger again because they have been suspended
                    // use setTimeout to give nodes a chance to update
                    again = function again() {
                      return _this15.discover_names('sws.geonames.org');
                    };

                    setTimeout(again, 100);
                  } else {
                    _this15.discover_geonames_as__widget.set_state('good'); // no more remaining lookups permitted
                ...
                msg = "state_at_start = ".concat(state_at_start, " but it should only be looking or trying (nameless: ").concat(_this15.nameless_set.length, ")");
              }
            } //console.error(msg)
            //throw new Error(msg)
            ...
            deeperQuad = null;
            greedily = _this15.discover_geonames_greedily;
            deeply = _this15.discover_geonames_deeply;
            depth = 0;
            ref = json.geonames; // from most specific to most general

            for (j = ref.length - 1; j >= 0; j += -1) {
              geoRec = ref[j];
              subj = geoNamesRoot + '/' + geoRec.geonameId + '/'; //console.log("discover_geoname_name(#{subj})")
              ...
              _this15.inject_discovered_quad_for(placeQuad, aUrl);

              seen_name = false; // climb the hierarchy of Places sent by GeoNames
              ...
              for (key in geoRec) {
                ...
                _this15.inject_discovered_quad_for(quad, aUrl);
              ...
              if (deeperQuad) {
                ...
                _this15.inject_discovered_quad_for(containershipQuad, aUrl);
              }
      ...
      key: "inject_discovered_quad_for",
      value: function inject_discovered_quad_for(quad, url) {
        var q; // Purpose:
      ...
      key: "deprefix",
      value: function deprefix(uri, prefix, expansion) {
        // Return uri replacing expansion with prefix if possible
        return uri.replace(expansion, prefix);
      }
    }, {
      key: "make_sqarql_name_for_getty",
      value: function make_sqarql_name_for_getty(uris, expansion, prefix) {
        var subj_constraint, uri; // This is good stuff which should be made a bit more general
        ...
        if (uris.length === 1) {
          // so just match that one uri directly
          subj_constraint = "BIND (?s AS <".concat(uris[0] // more than 1 so make a FILTER statement for the ?subj match
          , ">)");
        } else {
        ...
        return "PREFIX ".concat(prefix, " <").concat(expansion, ">\nSELECT * {\n  ?subj gvp:prefLabelGVP [xl:literalForm ?label] .\n  ").concat(subj_constraint // """
        , "\n }");
      }
    }, {
      key: "auto_discover_name_for",
      value: function auto_discover_name_for(uri) {
        ...
        try {
          ...
          e = error1;
          colorlog("skipping auto_discover_name_for('".concat(uri, "') because"));
          console.log(e);
          return;
        }
        ...
        if (uri.startsWith("http://id.loc.gov/")) {
          ...
          retval = this.ingest_quads_from("".concat(uri, ".skos.nt"), this.discover_labels(uri));
      ...
      key: "ingest_quads_from_sparql",
      value: function ingest_quads_from_sparql(sparql) {
        return console.info(sparql);
      }
    }, {
      key: "discover_names_including",
      value: function discover_names_including(includes) {
        if (this.nameless_set) {
          // this might be before the set exists
          this.discover_names(includes);
        }
      }
    }, {
      key: "discover_names",
      value: function discover_names(includes) {
        var j, len1, node, ref, url;
        ref = this.nameless_set; //console.log('discover_names(',includes,') # of nameless:',@nameless_set.length)
      ...
      key: "make_qname",
      value: function make_qname(uri) {
        // TODO(smurp) dear god! this method name is lying (it is not even trying)
        return uri;
      }
    }, {
      key: "add_quad",
      value: function add_quad(quad, sprql_subj) {
        //sprq_sbj only used in SPARQL quieries
        var cntx_n, ctxid, edge, isLiteral, is_type, literal_node, make_edge, newsubj, objId, objId_explanation, objKey, objVal, obj_n, pred_n, pred_uri, simpleType, subj, subj_lid, subj_n, subj_uri, use_thumb; // FIXME Oh! How this method needs a fine toothed combing!!!!
        ...
        newsubj = false;
        subj = null; //if @p_display then @performance_dashboard('add_quad')
        ...
        if (pred_uri.match(/\#(first|rest)$/)) {
          console.warn("add_quad() ignoring quad because pred_uri=".concat(pred_uri), quad);
          return;
          ...
          if (is_one_of(pred_uri, NAME_SYNS)) {
            ...
            if (this.make_nodes_for_literals) {
              ...
              if (quad.o.language && this.group_literals_by_subj_and_pred) {
                ...
                // node.
                objKey = "".concat(subj_n.lid, " ").concat(pred_uri);
                objId = synthIdFor(objKey);
                objId_explanation = "synthIdFor('".concat(objKey, "') = ").concat(objId);
        ...
        if (this.endpoint_loader != null && this.endpoint_loader.value) {
          ...
          if (subj_n.id === quad.subject) {
            // if it is the subject node then is fully_loaded
            subj_n.fully_loaded = true;
          }
        }
      ...
      key: "remove_from_nameless",
      value: function remove_from_nameless(node) {
        var node_removed;
      ...
      key: "add_to_nameless",
      value: function add_to_nameless(node) {
        var base1;
      ...
      key: "set_name",
      value: function set_name(node, full_name, lang) {
        var _this16 = this;

        var len, perform_rename; // So if we set the full_name to null that is to mean that we have
        // no good idea what the name yet.

        perform_rename = function perform_rename() {
          if (full_name != null) {
            if (!node.isLiteral) {
              _this16.remove_from_nameless(node);
            }
          } else {
            if (!node.isLiteral) {
              _this16.add_to_nameless(node);
            }

            full_name = node.lid || node.id;
          }

          if (_typeof(full_name) === 'object') {
      ...
      key: "scroll_pretty_name",
      value: function scroll_pretty_name(node) {
      ...
      key: "unscroll_pretty_name",
      value: function unscroll_pretty_name(node) {
        return this.set_name(node, node.name);
      }
    }, {
      key: "infer_edge_end_types",
      value: function infer_edge_end_types(edge) {
      ...
      key: "make_Edge_id",
      value: function make_Edge_id(subj_n, obj_n, pred_n) {
        var a;
        return function () {
          var j, len1, ref, results1;
      ...
      key: "get_or_create_Edge",
      value: function get_or_create_Edge(subj_n, obj_n, pred_n, cntx_n) {
        var edge, edge_id;
      ...
      key: "try_to_set_node_type",
      value: function try_to_set_node_type(node, type_uri) {
      ...
      key: "parseAndShowTTLData",
      value: function parseAndShowTTLData(data, textStatus, callback) {
        var blurt_msg, context, e, every, frame, j, len1, msg, obj, parse_start_time, pred, pred_id, quad_count, ref, ref1, ref2, subj_uri; // modelled on parseAndShowNQStreamer
        ...
        if (GreenerTurtle != null && this.turtle_parser === 'GreenerTurtle') {
          try {
            ...
            blurt_msg = "<p>There has been a problem with the Turtle parser.  Check your dataset for errors.</p><p class=\"js_msg\">".concat(msg, "</p>");
        ...
        for (subj_uri in ref) {
          frame = ref[subj_uri];
          ref1 = frame.predicates; //console.log "frame:",frame
          ...
          for (pred_id in ref1) {
            ...
            for (j = 0, len1 = ref2.length; j < len1; j++) {
              obj = ref2[j]; // this is the right place to convert the ids (URIs) to CURIES
              //   Or should it be QNames?
              //      http://www.w3.org/TR/curie/#s_intro

              if (every === 1) {
                this.show_state_msg("<LI>".concat(frame.id, " <LI>").concat(pred.id, " <LI>").concat(obj.value));
      ...
      key: "choose_everything",
      value: function choose_everything() {
        var cmd;
        cmd = new gcl.GraphCommand(this, {
          verbs: ['choose'],
          classes: ['Thing']
      ...
      key: "remove_framing_quotes",
      value: function remove_framing_quotes(s) {
        return s.replace(/^\"/, "").replace(/\"$/, "");
      }
    }, {
      key: "parseAndShowNQStreamer",
      value: function parseAndShowNQStreamer(uri, callback) {
        var _this18 = this;

        var owl_type_map, quad_count, worker; // turning a blob (data) into a stream
        ...
        worker.addEventListener('message', function (e) {
          ...
          if (e.data.event === 'line') {
            ...
            _this18.show_state_msg("<h3>Parsing... </h3><p>" + uri + "</p><progress value='" + quad_count + "' max='" + _this18.node_count + "'></progress>"); //if quad_count % 100 is 0
            ...
            if (q) {
              ...
              q.o = {
                ...
                value: unescape_unicode(_this18.remove_framing_quotes(q.o.toString()))
              };
            ...
            _this18.show_state_msg("<h3>Starting to split... </h3><p>" + uri + "</p>");

            _this18.node_count = e.data.numLines;
          } else if (e.data.event === 'finish') {
            msg = "finished_splitting " + uri;

            _this18.show_state_msg("done loading");

            _this18.after_file_loaded(uri, callback);
          } else {
            msg = "unrecognized NQ event:" + e.data.event;
          }

          if (msg != null) {
            return _this18.blurt(msg);
          }
        });
      ...
      key: "parse_and_show_NQ_file",
      value: function parse_and_show_NQ_file(data, callback) {
        var allLines, j, len1, line, owl_type_map, q, quad_count; //TODO There is currently no error catcing on local nq files
      ...
      key: "DUMPER",
      value: function DUMPER(data) {
        return console.log(data);
      }
    }, {
      key: "fetchAndShow",
      value: function fetchAndShow(url, callback) {
        var _this19 = this;
        ...
        if (url.match(/.ttl/)) {
          ...
          msg = "Could not load ".concat(url, ". The data file format is not supported! ") + "Only files with TTL and NQ extensions are accepted.";
          this.hide_state_msg();
        ...
        if (url.startsWith('file:///') || url.indexOf('/') === -1) {
          ...
          this.get_resource_from_db(url, function (err, rsrcRec) {
            ...
            _this19.blurt(err || "'".concat(url, " was not found in your DATASET menu.  Provide it and reload this page"));

            _this19.reset_dataset_ontology_loader();
          });
          return;
        }
        ...
        return $.ajax({
          ...
          success: function success(data, textStatus) {
            the_parser(data, textStatus, callback); //@fire_fileloaded_event(url) ## should call after_file_loaded(url, callback) within the_parser

            return _this19.hide_state_msg();
          },
          error: function error(jqxhr, textStatus, errorThrown) {
            ...
            _this19.hide_state_msg();

            $('#' + _this19.get_data_ontology_display_id()).remove();

            _this19.blurt(msg, 'error'); // trigger this by goofing up one of the URIs in cwrc_data.json


            return _this19.reset_dataset_ontology_loader();
          }
        });
      } //TODO Reset titles on page

    }, {
      key: "sparql_graph_query_and_show",
      value: function sparql_graph_query_and_show(url, id, callback) {
        var _this20 = this;
        ...
        */
        ...
        ajax_settings = {
          //TODO Currently this only works on CWRC Endpoint
          'type': 'GET',
        ...
        if (url === "http://sparql.cwrc.ca/sparql") {
          // Hack to make CWRC setup work properly
        ...
        */
        ...
        graphSelector = "#sparqlGraphOptions-".concat(id);
        $(graphSelector).parent().css('display', 'none');
        this.sparqlQryInput_hide();
        spinner = $("#sparqlGraphSpinner-".concat(id));
        ...
        return $.ajax({
          ...
          success: function success(data, textStatus, jqXHR) {
            ...
            if (graphsNotFound) {
              ...
              _this20.reset_endpoint_form(true);

              return;
            }

            graph_options = "<option id='".concat(_this20.unique_id(), "' value='").concat(url, "'> All Graphs </option>");

            for (j = 0, len1 = results.length; j < len1; j++) {
              graph = results[j];
              graph_options = graph_options + "<option id='".concat(_this20.unique_id(), "' value='").concat(graph.g.value, "'>").concat(graph.g.value, "</option>");
            }

            $("#sparqlGraphOptions-".concat(id)).html(graph_options);
            $(graphSelector).parent().css('display', 'block');
            return _this20.reset_endpoint_form(true);
          },
          error: function error(jqxhr, textStatus, errorThrown) {
            var msg;
            console.log(url, errorThrown);
            ...
            _this20.hide_state_msg();

            $('#' + _this20.get_data_ontology_display_id()).remove();

            _this20.blurt(msg, 'error'); // trigger this by goofing up one of the URIs in cwrc_data.json


            _this20.reset_dataset_ontology_loader();
      ...
      key: "sparqlQryInput_hide",
      value: function sparqlQryInput_hide() {
        return this.sparqlQryInput_JQElem.hide(); //css('display', 'none')
      }
    }, {
      key: "sparqlQryInput_show",
      value: function sparqlQryInput_show() {
      ...
      key: "load_endpoint_data_and_show",
      value: function load_endpoint_data_and_show(subject, callback) {
        var _this21 = this;
        ...
        */
        ...
        this.pfm_count('sparql'); //if @p_display then @performance_dashboard('sparql_request')
        ...
        if (this.endpoint_loader.endpoint_graph) {
          fromGraph = " FROM <".concat(this.endpoint_loader.endpoint_graph, "> ");
        }

        qry = "SELECT * ".concat(fromGraph, "\nWHERE {\n  {<").concat(subject, "> ?p ?o}\n  UNION\n  {{<").concat(subject, "> ?p ?o} . {?o ?p2 ?o2}}\nUNION\n  {{?s3 ?p3 <").concat(subject, ">} . {?s3 ?p4 ?o4 }}\n}\nLIMIT ").concat(node_limit);
        ajax_settings = {
          'method': 'GET',
          //'POST'
          'url': url + '?query=' + encodeURIComponent(qry),
        ...
        */
        ...
        return $.ajax({
          ...
          headers: ajax_settings.headers,
          success: function success(data, textStatus, jqXHR) {
            var disable, endpoint, json_check, json_data; //console.log jqXHR
            //console.log data
            ...
            _this21.add_nodes_from_SPARQL(json_data, subject);

            endpoint = _this21.endpoint_loader.value;

            _this21.dataset_loader.disable();

            _this21.ontology_loader.disable();

            _this21.replace_loader_display_for_endpoint(endpoint, _this21.endpoint_loader.endpoint_graph);

            disable = true;

            _this21.update_go_button(disable);

            _this21.big_go_button.hide();

            return _this21.after_file_loaded('sparql', callback);
          },
          error: function error(jqxhr, textStatus, errorThrown) {
            var msg;
            console.log(url, errorThrown);
            ...
            _this21.hide_state_msg();

            $('#' + _this21.get_data_ontology_display_id()).remove();

            _this21.blurt(msg, 'error'); // trigger this by goofing up one of the URIs in cwrc_data.json


            return _this21.reset_dataset_ontology_loader();
          }
        });
      }
    }, {
      key: "load_new_endpoint_data_and_show",
      value: function load_new_endpoint_data_and_show(subject, callback) {
        var _this22 = this;
        ...
        return $.ajax({
          ...
          headers: ajax_settings.headers,
          success: function success(data, textStatus, jqXHR) {
            var json_check, json_data; //console.log jqXHR
            //console.log "Query: " + subject

            note = subject;

            if (_this22.p_display) {
              _this22.performance_dashboard('sparql_request', note);
            } //console.log qry
            ...
            _this22.add_nodes_from_SPARQL(json_data, subject);

            _this22.shelved_set.resort();

            _this22.tick("Tick in load_new_endpoint_data_and_show success callback");

            _this22.update_all_counts();

            return _this22.endpoint_loader.outstanding_requests = _this22.endpoint_loader.outstanding_requests - 1;
          },
          ...
          error: function error(jqxhr, textStatus, errorThrown) {
            ...
            _this22.hide_state_msg();

            $('#' + _this22.get_data_ontology_display_id()).remove();

            _this22.blurt(msg, 'error'); // trigger this by goofing up one of the URIs in cwrc_data.json


            return _this22.reset_dataset_ontology_loader();
          }
        });
      }
    }, {
      key: "add_nodes_from_SPARQL",
      value: function add_nodes_from_SPARQL(json_data, subject) {
        // DEPRECIATED !!!!
        ...
        data = '';
        context = "http://universal.org";
        plainLiteral = "http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral"; //console.log json_data
        ...
        for (j = 0, len1 = nodes_in_data.length; j < len1; j++) {
          ...
          if (node_list_empty === 0) {
            // Add first node (because list is empty)
            this.sparql_node_list.push(q);
            node_not_in_list = true;
          } else {
            ref = this.sparql_node_list; // Check if node is in list - sparql_node_list is used to keep track of nodes that have already been
            // loaded by a query so that they will not be added again through add_quad.

            for (o = 0, len2 = ref.length; o < len2; o++) {
              snode = ref[o]; //TODO - This filtering statement doesn't seem tight (Will not catch nodes that HuViz creates - that's okay I think)

              if (q.s === snode.s && q.p === snode.p && q.o.value === snode.o.value && q.o.type === snode.o.type && q.o.language === snode.o.language) {
                node_not_in_list = false; //console.log "Found it in list so will not send to add_quad"

                if (snode.s === subject || snode.o.value === subject) {
                  //IF node is subject node IS already in list BUT fullly_loaded is false then set to true
                  ref1 = this.all_set;
      ...
      key: "add_nodes_from_SPARQL_Worker",
      value: function add_nodes_from_SPARQL_Worker(queryTarget) {
        var _this23 = this;
        ...
        worker.addEventListener('message', function (e) {
          var a_node, add_fully_loaded, i, j, len1, len2, o, quad, ref, ref1; //console.log e.data

          add_fully_loaded = e.data.fully_loaded_index;
          ref = e.data.results;

          for (j = 0, len1 = ref.length; j < len1; j++) {
            quad = ref[j]; //console.log quad

            _this23.add_quad(quad);

            _this23.sparql_node_list.push(quad); // Add the new quads to the official list of added quads
          ...
          ref1 = _this23.all_set; // Verify through the loaded nodes that they are all properly marked as fully_loaded

          for (i = o = 0, len2 = ref1.length; o < len2; i = ++o) {
            a_node = ref1[i];

            if (a_node.id === queryTarget) {
              _this23.all_set[i].fully_loaded = true;
            }
          }

          _this23.endpoint_loader.outstanding_requests = _this23.endpoint_loader.outstanding_requests - 1;
          console.log("Resort the shelf");

          _this23.shelved_set.resort();

          _this23.tick("Tick in add_nodes_from_SPARQL_worker");

          return _this23.update_all_counts();
        });
        return worker.postMessage({
          target: queryTarget,
          url: url,
      ...
      key: "show_and_hide_links_from_node",
      value: function show_and_hide_links_from_node(d) {
        this.show_links_from_node(d);
        return this.hide_links_from_node(d);
      }
    }, {
      key: "get_container_width",
      value: function get_container_width(pad) {
      ...
      key: "get_container_height",
      value: function get_container_height(pad) {
        pad = pad || hpad;
      ...
      key: "update_graph_radius",
      value: function update_graph_radius() {
      ...
      key: "update_graph_center",
      value: function update_graph_center() {
      ...
      key: "update_lariat_zone",
      value: function update_lariat_zone() {
        return this.lariat_center = [this.cx, this.cy];
      }
    }, {
      key: "update_discard_zone",
      value: function update_discard_zone() {
      ...
      key: "set_search_regex",
      value: function set_search_regex(text) {
        return this.search_regex = new RegExp(text || "^$", "ig");
      }
    }, {
      key: "update_searchterm",
      value: function update_searchterm() {
        var text;
        text = $(this).text();
      ...
      key: "dump_locations",
      value: function dump_locations(srch, verbose, func) {
        var _this24 = this;
        ...
        return nodes.forEach(function (node, i) {
          ...
          if (!func || verbose) {
            return _this24.dump_details(node);
          }
        });
      }
    }, {
      key: "get_node_by_id",
      value: function get_node_by_id(node_id, throw_on_fail) {
        var obj;
      ...
      key: "update_showing_links",
      value: function update_showing_links(n) {
        var old_status; // TODO understand why this is like {Taxon,Predicate}.update_state
      ...
      key: "should_show_link",
      value: function should_show_link(edge) {
        var d, e, ss, ts; // Edges should not be shown if either source or target are discarded or embryonic.
      ...
      key: "remove_link",
      value: function remove_link(edge_id) {
        var e;
        e = this.links_set.get_by('id', edge_id);

        if (e == null) {
          console.log("remove_link(".concat(edge_id, ") not found!"));
          return;
        }
      ...
      key: "show_link",
      value: function show_link(edge, incl_discards) {
      ...
      key: "unshow_link",
      value: function unshow_link(edge) {
        this.remove_from(edge, edge.source.links_shown);
        this.remove_from(edge, edge.target.links_shown);
        this.links_set.remove(edge); //console.log("unshowing links from: " + edge.id)
      ...
      key: "show_links_to_node",
      value: function show_links_to_node(n, incl_discards) {
        var _this25 = this;

        incl_discards = incl_discards || false; //if not n.links_to_found
        //  @find_links_to_node n,incl_discards

        n.links_to.forEach(function (e, i) {
          return _this25.show_link(e, incl_discards);
        });
      ...
      key: "update_state",
      value: function update_state(node) {
      ...
      key: "hide_links_to_node",
      value: function hide_links_to_node(n) {
        var _this26 = this;

        n.links_to.forEach(function (e, i) {
          _this26.remove_from(e, n.links_shown);

          _this26.remove_from(e, e.source.links_shown);

          e.unshow();

          _this26.links_set.remove(e);

          _this26.remove_ghosts(e);

          _this26.update_state(e.source);

          _this26.update_showing_links(e.source);

          return _this26.update_showing_links(e.target);
        });
        this.update_state(n);
        this.force.links(this.links_set);
      ...
      key: "show_links_from_node",
      value: function show_links_from_node(n, incl_discards) {
        var _this27 = this;

        incl_discards = incl_discards || false; //if not n.links_from_found
        //  @find_links_from_node n

        n.links_from.forEach(function (e, i) {
          return _this27.show_link(e, incl_discards);
        });
        this.update_state(n);
        this.force.links(this.links_set);
      ...
      key: "hide_links_from_node",
      value: function hide_links_from_node(n) {
        var _this28 = this;

        n.links_from.forEach(function (e, i) {
          _this28.remove_from(e, n.links_shown);

          _this28.remove_from(e, e.target.links_shown);

          e.unshow();

          _this28.links_set.remove(e);

          _this28.remove_ghosts(e);

          _this28.update_state(e.target);

          _this28.update_showing_links(e.source);

          return _this28.update_showing_links(e.target);
        });
        this.force.links(this.links_set);
      ...
      key: "attach_predicate_to_its_parent",
      value: function attach_predicate_to_its_parent(a_pred) {
      ...
      key: "get_or_create_predicate_by_id",
      value: function get_or_create_predicate_by_id(sid) {
        var obj_id, obj_n;
      ...
      key: "clean_up_dirty_predicates",
      value: function clean_up_dirty_predicates() {
        var pred;
      ...
      key: "clean_up_dirty_taxons",
      value: function clean_up_dirty_taxons() {
        if (this.taxonomy.Thing != null) {
          return this.taxonomy.Thing.clean_up_dirt();
        }
      }
    }, {
      key: "clean_up_all_dirt_once",
      value: function clean_up_all_dirt_once() {
        if (this.clean_up_all_dirt_onceRunner == null) {
      ...
      key: "clean_up_all_dirt",
      value: function clean_up_all_dirt() {
      ...
      key: "prove_OnceRunner",
      value: function prove_OnceRunner(timeout) {
        var yahoo;
      ...
      key: "get_or_create_context_by_id",
      value: function get_or_create_context_by_id(sid) {
        var obj_id, obj_n;
        obj_id = this.make_qname(sid);
      ...
      key: "get_or_create_node_by_id",
      value: function get_or_create_node_by_id(uri, name, isLiteral) {
        var node, node_id; // FIXME OMG must standardize on .lid as the short local id, ie internal id
        ...
        if (node == null) {
          ...
          if (node.id == null) {
            alert("new Node('".concat(uri, "') has no id"));
          } //@nodes.add(node)
      ...
      key: "hatch",
      value: function hatch(node) {
        var new_set, start_point; // Take a node from being 'embryonic' to being a fully graphable node
      ...
      key: "get_or_create_transient_node",
      value: function get_or_create_transient_node(subjNode, point) {
      ...
      key: "make_nodes",
      value: function make_nodes(g, limit) {
        var count, ref, results1, subj, subj_uri, subject;
        limit = limit || 0;
        count = 0;
        ref = g.subjects; //my_graph.subjects

        results1 = [];

        for (subj_uri in ref) {
          subj = ref[subj_uri]; //console.log subj, g.subjects[subj]  if @verbosity >= @DEBUG
      ...
      key: "make_links",
      value: function make_links(g, limit) {
        var _this29 = this;
        ...
        this.nodes.some(function (node, i) {
          ...
          _this29.show_links_from_node(_this29.nodes[i]);

          if (limit > 0 && _this29.links_set.length >= limit) {
            return true;
          }
        });
        return this.restart();
      ...
      key: "hide_node_links",
      value: function hide_node_links(node) {
        var _this30 = this;

        node.links_shown.forEach(function (e, i) {
          _this30.links_set.remove(e);

          if (e.target === node) {
            _this30.remove_from(e, e.source.links_shown);

            _this30.update_state(e.source);

            e.unshow();

            _this30.update_showing_links(e.source);
          } else {
            _this30.remove_from(e, e.target.links_shown);

            _this30.update_state(e.target);

            e.unshow();

            _this30.update_showing_links(e.target);
          }

          return _this30.remove_ghosts(e);
        });
        node.links_shown = [];
      ...
      key: "hide_found_links",
      value: function hide_found_links() {
        var _this31 = this;

        this.nodes.forEach(function (node, i) {
          if (node.name.match(search_regex)) {
            return _this31.hide_node_links(node);
          }
        });
        return this.restart();
      }
    }, {
      key: "discard_found_nodes",
      value: function discard_found_nodes() {
        var _this32 = this;

        this.nodes.forEach(function (node, i) {
          if (node.name.match(search_regex)) {
            return _this32.discard(node);
          }
        });
        return this.restart();
      }
      ...
      key: "show_node_links",
      value: function show_node_links(node) {
        this.show_links_from_node(node);
        this.show_links_to_node(node);
        return this.update_showing_links(node);
      }
    }, {
      key: "toggle_display_tech",
      value: function toggle_display_tech(ctrl, tech) {
        var val;
        val = void 0;
      ...
      key: "label",
      value: function label(branded) {
        this.labelled_set.add(branded);
      }
    }, {
      key: "unlabel",
      value: function unlabel(anonymized) {
        this.labelled_set.remove(anonymized);
      }
    }, {
      key: "get_point_from_polar_coords",
      value: function get_point_from_polar_coords(polar) {
      ...
      key: "unlink",
      value: function unlink(unlinkee) {
      ...
      key: "discard",
      value: function discard(goner) {
        var shown;
        this.unpin(goner);
        this.unlink(goner);
        this.discarded_set.acquire(goner);
        shown = this.update_showing_links(goner);
        this.unselect(goner); //@update_state(goner)

        return goner;
      }
    }, {
      key: "undiscard",
      value: function undiscard(prodigal) {
        // TODO(smurp) rename command to 'retrieve' ????
      ...
      key: "choose",
      value: function choose(chosen) {
        var message, msg, shownness; // If this chosen node is part of a SPARQL query set, then check if it is fully loaded
        // if it isn't then load and activate
        //console.log chosen

        if (this.endpoint_loader != null && this.endpoint_loader.value) {
          // This is part of a sparql set
          if (!chosen.fully_loaded) {
            ...
            if (this.endpoint_loader.outstanding_requests < 10) {
              ...
              this.endpoint_loader.outstanding_requests++; //console.log "Less than 6 so go ahead " + message
      ...
      key: "unchoose",
      value: function unchoose(unchosen) {
        var j, link, ref; // To unchoose a node is to remove the chosen flag and unshow the edges
      ...
      key: "wander__atFirst",
      value: function wander__atFirst() {
        var j, len1, node, ref, results1; // Purpose:
      ...
      key: "wander__atLast",
      value: function wander__atLast() {
        var _this33 = this;

        var j, len1, node, nowRollCall, removed, wasRollCall; // Purpose:
        ...
        removed = this.wasChosen_set.filter(function (node) {
          return !_this33.nowChosen_set.includes(node);
        });
      ...
      key: "unwalk",
      value: function unwalk(node) {
        this.walked_set.remove(node);
        delete node.walkedIdx0;
      }
    }, {
      key: "walkBackTo",
      value: function walkBackTo(existingStep) {
        var j, pathNode, ref, removed; // note that if existingStep is null (ie a non-node) we will walk back all
      ...
      key: "walkBackAll",
      value: function walkBackAll() {
        return this.walkBackTo(null);
      }
    }, {
      key: "walk",
      value: function walk(nextStep) {
        ...
        if (!nextStep.walked) {
          // It might already be in the path, if not...
        ...
        if (tooHairy) {
          // as promised we now deal with the last node
      ...
      key: "nodesAreAdjacent",
      value: function nodesAreAdjacent(n1, n2) {
        var busyNode, j, len1, len2, link, lonelyNode, o, ref, ref1; // figure out which node is least connected so we do the least work checking links
        ...
        ref = lonelyNode.links_from; // iterate through the outgoing links of the lonlier node, breaking on adjacency
        ...
        ref1 = lonelyNode.links_to; // iterate through the incoming links of the lonlier node, breaking on adjacency
      ...
      key: "edgeIsOnWalkedPath",
      value: function edgeIsOnWalkedPath(edge) {
        return this.nodesAreAdjacentOnWalkedPath(edge.target, edge.source);
      }
    }, {
      key: "nodesAreAdjacentOnWalkedPath",
      value: function nodesAreAdjacentOnWalkedPath(n1, n2) {
      ...
      value: function select(node) {
        ...
        if (node.selected == null) {
          ...
          if (node.select != null) {
            ...
            msg = "".concat(node.__proto__.constructor.name, " ").concat(node.id, " lacks .select()");
            throw msg;
      ...
      value: function connect(node) {
        if (node !== this.focused_node) {
          console.info("connect('".concat(node.lid, "') SKIPPING because it is not the focused node"));
          return;
        }
      ...
      key: "set_unique_color",
      value: function set_unique_color(uniqcolor, set, node) {
        var old_node;
      ...
      key: "animate_hunt",
      value: function animate_hunt(array, sought_node, mid_node, prior_node, pos) {
        var cmd, cmdArgs, edge, pred_uri, trail_pred; //sought_node.color = 'red'
      ...
      key: "recolor_node",
      value: function recolor_node(n, default_color) {
      ...
      key: "get_color_for_node_type",
      value: function get_color_for_node_type(node, type) {
        var state;
      ...
      key: "recolor_nodes",
      value: function recolor_nodes() {
        var j, len1, node, ref, results1; // The nodes needing recoloring are all but the embryonic.
      ...
      key: "toggle_selected",
      value: function toggle_selected(node) {
        if (node.selected != null) {
          this.unselect(node);
        } else {
          this.select(node);
      ...
      key: "get_snippet_url",
      value: function get_snippet_url(snippet_id) {
        if (snippet_id.match(/http\:/)) {
          return snippet_id;
        } else {
          return "".concat(window.location.origin).concat(this.get_snippetServer_path(snippet_id));
        }
      }
    }, {
      key: "get_snippetServer_path",
      value: function get_snippetServer_path(snippet_id) {
        var ref, which; // this relates to index.coffee and the urls for the
        ...
        return "/snippet/".concat(which, "/").concat(snippet_id, "/");
      }
    }, {
      key: "get_snippet_js_key",
      value: function get_snippet_js_key(snippet_id) {
      ...
      key: "get_snippet",
      value: function get_snippet(snippet_id, callback) {
      ...
      key: "clear_snippets",
      value: function clear_snippets(evt) {
      ...
      key: "init_snippet_box",
      value: function init_snippet_box() {
      ...
      key: "remove_snippet",
      value: function remove_snippet(snippet_id) {
        var key, slctr;
      ...
      key: "push_snippet",
      value: function push_snippet(obj, msg) {
        var _this34 = this;
        ...
        if (this.snippet_box) {
          ...
          dialog_args = {
            ...
            close: function close(event, ui) {
              ...
              delete _this34.snippet_positions_filled[my_position];
              delete _this34.currently_printed_snippets[event.target.id];
            }
          };
          ...
          close_all_button = bomb_parent.append('<button type="button" class="ui-button ui-corner-all ui-widget close-all" role="button" title="Close All""><img class="close_all_snippets_button" src="close_all.png" title="Close All"></button>'); //append('<span class="close_all_snippets_button" title="Close All"></span>')
      ...
      key: "get_next_snippet_position",
      value: function get_next_snippet_position() {
        var height, hinc, hoff, left_full, retval, top_full, vinc, voff, width; // Fill the left edge, then the top edge, then diagonally from top-left
        ...
        hoff = 0;
        voff = 0;
        retval = "left+".concat(hoff, " top+").concat(voff);
      ...
      key: "remove_tags",
      value: function remove_tags(xml) {
      ...
      key: "unflag_all_edges",
      value: function unflag_all_edges(node) {
        var edge, j, len1, ref, results1;
        ref = node.links_shown;
        results1 = [];
      ...
      key: "print_edge",
      value: function print_edge(edge) {
        var _this35 = this;

        var context, context_no, j, len1, make_callback, me, ref, results1, snippet_js_key; // @clear_snippets()
        ...
        for (j = 0, len1 = ref.length; j < len1; j++) {
          ...
          make_callback = function make_callback(context_no, edge, context) {
      ...
      key: "redact",
      value: function redact(node) {
        var _this36 = this;

        return node.links_shown.forEach(function (edge, i) {
          return _this36.remove_snippet(edge.id);
        });
      }
    }, {
      key: "draw_edge_regarding",
      value: function draw_edge_regarding(node, predicate_lid) {
        var _this37 = this;

        var dirty, doit;
        dirty = false;

        doit = function doit(edge, i, frOrTo) {
          if (edge.predicate.lid === predicate_lid) {
            if (edge.shown == null) {
              _this37.show_link(edge);
      ...
      key: "undraw_edge_regarding",
      value: function undraw_edge_regarding(node, predicate_lid) {
        var _this38 = this;
        ...
        doit = function doit(edge, i, frOrTo) {
          if (edge.predicate.lid === predicate_lid) {
            dirty = true;
            return _this38.unshow_link(edge);
          }
        };
      ...
      key: "restore_graph_state",
      value: function restore_graph_state(state) {
        var _this39 = this;
        ...
        if (state.chosen_node_ids) {
          ...
          return state.chosen_node_ids.forEach(function (chosen_id) {
            ...
            if (chosen) {
              return _this39.choose(chosen);
            }
          });
        }
      }
    }, {
      key: "fire_showgraph_event",
      value: function fire_showgraph_event() {
      ...
      key: "show_the_edges",
      value: function show_the_edges() {} //edge_controller.show_tree_in.call(arguments)

    }, {
      key: "register_gclc_prefixes",
      value: function register_gclc_prefixes() {
      ...
      value: function init_datasetDB() {
        ...
        if (!this.datasetDB && indexedDB) {
          ...
          request.onsuccess = function (evt) {
            _this40.datasetDB = request.result;

            _this40.datasetDB.onerror = function (err) {
              return alert("Database error: ".concat(e.target.errorCode));
            }; //alert "onsuccess"


            return _this40.populate_menus_from_IndexedDB('onsuccess');
          };

          request.onerror = function (err) {
            return alert("unable to init ".concat(_this40.dbName));
          };
          ...
          return request.onupgradeneeded = function (event) {
            ...
            return objectStore.transaction.oncomplete = function (evt) {
              _this40.datasetDB = db; // alert "onupgradeneeded"

              return _this40.populate_menus_from_IndexedDB('onupgradeneeded');
            };
          };
        }
      }
      ...
      key: "ensure_datasets",
      value: function ensure_datasets(preload_group, store_in_db) {
        var defaults, ds_rec, j, k, len1, ref, results1; // note "fat arrow" so this can be an AJAX callback (see preload_datasets)

        defaults = preload_group.defaults || {};
        ref = preload_group.datasets; //console.log preload_group # THIS IS THE ITEMS IN A FILE (i.e. cwrc.json, generes.json)

        results1 = [];

        for (j = 0, len1 = ref.length; j < len1; j++) {
          ds_rec = ref[j]; // If this preload_group has defaults apply them to the ds_rec if it is missing that value.
      ...
      key: "ensure_dataset",
      value: function ensure_dataset(rsrcRec, store_in_db) {
        var uri; // ensure the dataset is in the database and the correct
      ...
      key: "add_resource_to_db",
      value: function add_resource_to_db(rsrcRec, callback) {
        var _this41 = this;
        ...
        trx.oncomplete = function (e) {
          return console.log("".concat(rsrcRec.uri, " added!"));
        };

        trx.onerror = function (e) {
          console.log(e);
          return alert("add_resource(".concat(rsrcRec.uri, ") error!!!"));
        };
        ...
        return req.onsuccess = function (e) {
          if (rsrcRec.isEndpoint) {
            _this41.sparql_graph_query_and_show(e.srcElement.result, _this41.endpoint_loader.select_id); //console.log @dataset_loader


            $("#".concat(_this41.dataset_loader.uniq_id)).children('select').prop('disabled', 'disabled');
            $("#".concat(_this41.ontology_loader.uniq_id)).children('select').prop('disabled', 'disabled');
            $("#".concat(_this41.script_loader.uniq_id)).children('select').prop('disabled', 'disabled');
          }

          if (rsrcRec.uri !== e.target.result) {
            console.debug("rsrcRec.uri (".concat(rsrcRec.uri, ") is expected to equal"), e.target.result);
          }
      ...
      key: "remove_dataset_from_db",
      value: function remove_dataset_from_db(dataset_uri, callback) {
        var req, store, trx;
        trx = this.datasetDB.transaction('datasets', "readwrite");

        trx.oncomplete = function (e) {
          return console.log("".concat(dataset_uri, " deleted"));
        };

        trx.onerror = function (e) {
          console.log(e);
          return alert("remove_dataset_from_db(".concat(dataset_uri, ") error!!!"));
        };
      ...
      key: "get_resource_from_db",
      value: function get_resource_from_db(rsrcUri, callback) {
        var req, store, trx;
        trx = this.datasetDB.transaction('datasets', "readwrite");

        trx.oncomplete = function (evt) {
          return console.log("get_resource_from_db('".concat(rsrcUri, "') complete, either by success or error"));
        };
        ...
        trx.onerror = function (err) {
          ...
          if (callback != null) {
            ...
            alert("get_resource_from_db(".concat(rsrcUri, ") error!!!"));
            throw err;
          }
        };
        ...
        req.onerror = function (err) {
          console.debug("get_resource_from_db('".concat(rsrcUri, "') onerror ==>"), err);
      ...
      key: "populate_menus_from_IndexedDB",
      value: function populate_menus_from_IndexedDB(why) {
        var _this42 = this;

        var count, datasetDB_objectStore, make_onsuccess_handler; // https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Using_IndexedDB#Using_a_cursor

        console.log("populate_menus_from_IndexedDB(".concat(why, ")"));
        datasetDB_objectStore = this.datasetDB.transaction('datasets').objectStore('datasets');
        count = 0;

        make_onsuccess_handler = function make_onsuccess_handler(why) {
          var recs;
          recs = [];
          return function (event) {
            ...
            if (cursor) {
              ...
              if ((ref = rec.rsrcType) === 'dataset' || ref === 'ontology' || legacyDataset || legacyOntology) {
                ...
                _this42.dataset_loader.add_resource_option(rec);
              }

              if (rec.rsrcType === 'ontology' || legacyOntology) {
                // only datasets are added to the dataset menu
                _this42.ontology_loader.add_resource_option(rec);
              }

              if (rec.rsrcType === 'script') {
                _this42.script_loader.add_resource_option(rec);
              }

              if (rec.rsrcType === 'endpoint') {
                _this42.endpoint_loader.add_resource_option(rec);
              }
              ...
              _this42.dataset_loader.val('');

              _this42.ontology_loader.val('');

              _this42.endpoint_loader.val('');

              _this42.script_loader.val('');

              _this42.update_dataset_ontology_loader();
      ...
      key: "preload_datasets",
      value: function preload_datasets() {
        var _this43 = this;

        var j, len1, preload_group_or_uri, ref; // If present args.preload is expected to be a list or urls or objects.
        ...
        console.groupCollapsed("preload_datasets"); // Adds preload options to datasetDB table
      ...
      key: "preload_endpoints",
      value: function preload_endpoints() {
        var _this44 = this;
          ...
          for (j = 0, len1 = ref.length; j < len1; j++) {
            ...
            if (typeof preload_group_or_uri === 'string') {
              ...
              $.ajax({
                ...
                url: preload_group_or_uri,
                success: function success(data, textStatus) {
                  return _this44.ensure_datasets_from_XHR(data);
                },
                error: function error(jqxhr, textStatus, errorThrown) {
                  return console.error(preload_group_or_uri + " " + textStatus + " " + errorThrown.toString());
                }
      ...
      key: "ensure_datasets_from_XHR",
      value: function ensure_datasets_from_XHR(preload_group) {
        this.ensure_datasets(preload_group, false); // false means DO NOT store_in_db
      }
    }, {
      key: "get_menu_by_rsrcType",
      value: function get_menu_by_rsrcType(rsrcType) {
        return this[rsrcType + '_loader'];
      }
    }, {
      key: "get_or_create_sel_for_picker",
      value: function get_or_create_sel_for_picker(specificSel) {
        var huvis_controls_sel, pickersId, sel; // if specificSel is defined, return it, otherwise return the selector of a thin
          ...
          if (this.pickersSel == null) {
            ...
            if (huvis_controls_sel = this.oldToUniqueTabSel['huvis_controls']) {
              ...
              if (this.huvis_controls_elem) {
                this.huvis_controls_elem.insertAdjacentHTML('beforeend', "<div id=\"".concat(pickersId, "\"></div>"));
              }
            }
          }
      ...
      key: "init_resource_menus",
      value: function init_resource_menus() {
        var endpoint_selector, last_val, sel; // REVIEW See views/huviz.html.eco to set dataset_loader__append_to_sel and similar
        ...
        if (this.endpoint_loader && !this.big_go_button) {
          ...
          endpoint_selector = "#".concat(this.endpoint_loader.select_id);
      ...
      key: "update_graph_form",
      value: function update_graph_form(e) {
        //console.log e.currentTarget.value
        return this.endpoint_loader.endpoint_graph = e.currentTarget.value;
      }
    }, {
      key: "visualize_dataset_using_ontology",
      value: function visualize_dataset_using_ontology(ignoreEvent, dataset, ontologies) {
        ...
        data = dataset || this.dataset_loader; // at this point data and onto are both objects with a .value key, containing url or fname
      ...
      key: "after_visualize_dataset_using_ontology",
      value: function after_visualize_dataset_using_ontology() {
        return this.preset_discover_geonames_remaining();
      }
    }, {
      key: "load_script_from_db",
      value: function load_script_from_db(err, rsrcRec) {
        if (err != null) {
      ...
      value: function init_gclc() {
        ...
        if (!this.show_class_instance_edges) {
          TYPE_SYNS.forEach(function (pred_id, i) {
            return _this45.gclui.ignore_predicate(pred_id);
          });
        }
      ...
      key: "disable_dataset_ontology_loader",
      value: function disable_dataset_ontology_loader(data, onto) {
        var disable;
      ...
      key: "reset_dataset_ontology_loader",
      value: function reset_dataset_ontology_loader() {
        $('#' + this.get_data_ontology_display_id()).remove(); //Enable dataset loader and reset to default setting

        this.dataset_loader.enable();
        this.ontology_loader.enable();
        this.big_go_button.show();
        $("#".concat(this.dataset_loader.select_id, " option[label='Pick or Provide...']")).prop('selected', true);
        return this.gclui_JQElem.removeAttr("style", "display:none");
      }
    }, {
      key: "update_dataset_ontology_loader",
      value: function update_dataset_ontology_loader() {
        var _this46 = this;
        ...
        ugb = function ugb() {
          return _this46.update_go_button();
        };

        return setTimeout(ugb, 200);
      }
    }, {
      key: "update_endpoint_form",
      value: function update_endpoint_form(e) {
        var graphSelector; //check if there are any endpoint selections available

        graphSelector = "#sparqlGraphOptions-".concat(e.currentTarget.id);
        $(graphSelector).change(this.update_graph_form);

        if (e.currentTarget.value === '') {
          $("#".concat(this.dataset_loader.uniq_id)).children('select').prop('disabled', false);
          $("#".concat(this.ontology_loader.uniq_id)).children('select').prop('disabled', false);
          $("#".concat(this.script_loader.uniq_id)).children('select').prop('disabled', false);
          $(graphSelector).parent().css('display', 'none');
          ...
          this.sparql_graph_query_and_show(e.currentTarget.value, e.currentTarget.id); //console.log @dataset_loader

          $("#".concat(this.dataset_loader.uniq_id)).children('select').prop('disabled', 'disabled');
          $("#".concat(this.ontology_loader.uniq_id)).children('select').prop('disabled', 'disabled');
          return $("#".concat(this.script_loader.uniq_id)).children('select').prop('disabled', 'disabled');
        }
      }
    }, {
      key: "reset_endpoint_form",
      value: function reset_endpoint_form(show) {
        var spinner;
        spinner = $("#sparqlGraphSpinner-".concat(this.endpoint_loader.select_id));
      ...
      key: "update_go_button",
      value: function update_go_button(disable) {
        var ds_on, ds_v, on_v;
        ...
        if (disable == null) {
          if (this.script_loader.value) {
            ...
            on_v = this.ontology_loader.value; //console.log("DATASET: #{ds_v}\nONTOLOGY: #{on_v}")

            disable = !(ds_v && on_v) || 'provide' === ds_v || 'provide' === on_v;
            ds_on = "".concat(ds_v, " AND ").concat(on_v);
          }
        }
      ...
      key: "get_reload_uri",
      value: function get_reload_uri() {
        return this.reload_uri || new URL(window.location);
      }
    }, {
      key: "generate_reload_uri",
      value: function generate_reload_uri(dataset, ontology) {
        var uri;
        this.reload_uri = uri = new URL(location);
        uri.hash = "load+".concat(dataset.value, "+with+").concat(ontology.value);
        return uri;
      }
    }, {
      key: "get_data_ontology_display_id",
      value: function get_data_ontology_display_id() {
      ...
      key: "hide_pickers",
      value: function hide_pickers() {
        return $(this.pickersSel).attr("style", "display:none");
      }
    }, {
      key: "replace_loader_display",
      value: function replace_loader_display(dataset, ontology) {
        var controls, data_ontol_display, sel, uri;
        this.generate_reload_uri(dataset, ontology);
        uri = this.get_reload_uri();
        this.hide_pickers();
        data_ontol_display = "<div id=\"".concat(this.get_data_ontology_display_id(), "\" class=\"data_ontology_display\">\n  <p><span class=\"dt_label\">Dataset:</span> ").concat(dataset.label, "</p>\n  <p><span class=\"dt_label\">Ontology:</span> ").concat(ontology.label, "</p>\n  <p>\n    <button title=\"Reload this data\"\n       onclick=\"location.replace('").concat(uri // """ the extra set of triple double quotes is for emacs coffescript mode
      ...
      key: "replace_loader_display_for_endpoint",
      value: function replace_loader_display_for_endpoint(endpoint, graph) {
        var data_ontol_display, print_graph;
        $(this.pickersSel).attr("style", "display:none"); //uri = new URL(location)
        //uri.hash = "load+#{dataset.value}+with+#{ontology.value}"

        if (graph) {
          print_graph = "<p><span class='dt_label'>Graph:</span> ".concat(graph, "</p>");
        } else {
          print_graph = "";
        }

        data_ontol_display = "<div id=\"".concat(this.get_data_ontology_display_id(), "\">\n  <p><span class=\"dt_label\">Endpoint:</span> ").concat(endpoint, "</p>\n  ").concat(print_graph, "\n  <br style=\"clear:both\">\n</div>");
        return $("#huvis_controls").prepend(data_ontol_display);
      }
    }, {
      key: "update_browser_title",
      value: function update_browser_title(dataset) {
        if (dataset.value) {
      ...
      key: "make_git_link",
      value: function make_git_link() {
        var base;
        base = this.args.git_base_url;
        return "<a class=\"git_commit_hash_watermark subliminal\"\ntarget=\"huviz_version\"  tabindex=\"-1\"\nhref=\"".concat(base).concat(this.git_commit_hash, "\">").concat(this.git_commit_hash // """
        , "</a>");
      }
    }, {
      key: "create_caption",
      value: function create_caption() {
        var dm, om;
      ...
      value: function set_ontology_from_dataset_if_possible() {
        ...
        if (this.dataset_loader.value) {
          ...
          if (ontologyUri) {
            // let the uri (if present) dominate the label
      ...
      key: "set_ontology_with_label",
      value: function set_ontology_with_label(ontology_label) {
        var j, len1, ont_opt, ref, sel, topSel;
        topSel = this.args.huviz_top_sel;
        sel = topSel + " [label='".concat(ontology_label, "']");
        ref = $(sel); // FIXME make this re-entrant
      ...
      key: "set_dataset_with_uri",
      value: function set_dataset_with_uri(uri) {
        var option, topSel;
        topSel = this.args.huviz_top_sel;
      ...
      key: "set_ontology_with_uri",
      value: function set_ontology_with_uri(ontologyUri) {
      ...
      key: "build_sparql_form",
      value: function build_sparql_form() {
        var endpoint_labels_id, endpoint_limit_id, fromGraph, select_box, sparqlQryInput_id;
        this.sparqlId = unique_id();
        sparqlQryInput_id = "sparqlQryInput_".concat(this.sparqlId);
        ...
        select_box = "<div class='ui-widget' style='display:none;margin-top:5px;margin-left:10px;'>\n  <label>Graphs: </label>\n  <select id=\"sparqlGraphOptions-".concat(this.endpoint_loader.select_id, "\">\n  </select>\n</div>\n<div id=\"sparqlGraphSpinner-").concat(this.endpoint_loader.select_id, "\"\n     style='display:none;font-style:italic;'>\n  <i class='fas fa-spinner fa-spin' style='margin: 10px 10px 0 50px;'></i>  Looking for graphs...\n</div>\n<div id=\"").concat(sparqlQryInput_id, "\" class=\"ui-widget sparqlQryInput\"\n     style='display:none;margin-top:5px;margin-left:10px;color:#999;'>\n  <label for='").concat(endpoint_labels_id, "'>Find: </label>\n  <input id='").concat(endpoint_labels_id, "'>\n  <i class='fas fa-spinner fa-spin' style='visibility:hidden;margin-left: 5px;'></i>\n  <div><label for='").concat(endpoint_limit_id, "'>Node Limit: </label>\n  <input id='").concat(endpoint_limit_id // """
        , "' value='100'>\n  </div>\n</div>");
      ...
      key: "populate_graphs_selector",
      value: function populate_graphs_selector(request, response) {
        var _this47 = this;
        ...
        return $.ajax({
          method: ajax_settings.method,
          // "type" used in eariler jquery
          url: ajax_settings.url,
          headers: ajax_settings.headers,
          success: function success(data, textStatus, jqXHR) {
            var j, json_check, json_data, label, len1, results, selections, this_result; //console.log jqXHR
            //console.log data
            ...
            for (j = 0, len1 = results.length; j < len1; j++) {
              label = results[j];
              this_result = {
                label: label.obj.value + " (".concat(label.sub.value, ")"),
          ...
          error: function error(jqxhr, textStatus, errorThrown) {
            ...
            _this47.hide_state_msg();

            $('#' + _this47.get_data_ontology_display_id()).remove();

            _this47.endpoint_labels_JQElem.siblings('i').css('visibility', 'hidden');

            return _this47.blurt(msg, 'error');
          }
        });
      }
    }, {
      key: "init_editc_or_not",
      value: function init_editc_or_not() {
        if (this.editui == null) {
      ...
      key: "run_verb_on_object",
      value: function run_verb_on_object(verb, subject) {
        var args, cmd;
        args = {
          verbs: [verb],
      ...
      key: "before_running_command",
      value: function before_running_command() {
      ...
      key: "after_running_command",
      value: function after_running_command() {
        //toggle_suspend_updates(false)
        this.text_cursor.set_cursor("default"); //$("body").css "background-color", renderStyles.pageBg # FIXME remove once it works!
      ...
      key: "get_handle",
      value: function get_handle(thing) {
        return {
      ...
      key: "set_logging",
      value: function set_logging(new_state) {
        if (new_state) {
      ...
      key: "create_state_msg_box",
      value: function create_state_msg_box() {
      ...
      key: "init_ontology",
      value: function init_ontology() {
        this.create_taxonomy();
        return this.ontology = PRIMORDIAL_ONTOLOGY;
      }
    }, {
      key: "get_default_tab",
      value: function get_default_tab(id) {
        var j, len1, ref, tab;
      ...
      key: "make_tabs_html",
      value: function make_tabs_html() {
        var _this48 = this;

        var firstClass, firstClass_, html, id, idSel, j, jQElem_list, len1, mkcb, t, tab_specs, theDivs, theTabs; // The firstClass in cssClass acts like a re-entrant identifier for these
        ...
        for (j = 0, len1 = tab_specs.length; j < len1; j++) {
          ...
          theTabs += "<li><a href=\"".concat(idSel, "\" title=\"").concat(t.title, "\">").concat(t.text, "</a></li>");
          theDivs += "<div id=\"".concat(id, "\" class=\"").concat(t.cssClass, "\">").concat(t.kids || '', "</div>");
          ...
          if (t.moveSelector != null) {
            mkcb = function mkcb(fromSel, toSel) {
              // make closure
              return function () {
                return _this48.moveSelToSel(fromSel, toSel);
              };
            };
        ...
        html = ["<section id=\"".concat(this.tabs_id, "\" class=\"huviz_tabs\" role=\"controls\">"), theTabs, theDivs, "</section>"].join('');
        return [html, jQElem_list];
      }
    }, {
      key: "moveSelToSel",
      value: function moveSelToSel(moveSel, targetSel) {
        var moveElem, targetElem;

        if (!(moveElem = document.querySelector(moveSel))) {
          console.warn("moveSelector() failed to find moveSel: '".concat(moveSel, "'"));
          return;
        }

        if (!(targetElem = document.querySelector(targetSel))) {
          console.warn("moveSelector() failed to find targetSel: '".concat(targetSel, "'"));
          return;
        }
      ...
      key: "withUriDo",
      value: function withUriDo(url, sel, processor) {
        var _this49 = this;
        ...
        xhr.onload = function (e) {
          if (xhr.readyState === 4) {
            if (xhr.status === 200) {
              ...
              return _this49.renderIntoWith(xhr.responseText, sel, processor);
            } else {
      ...
      key: "renderIntoWith",
      value: function renderIntoWith(data, sel, processor) {
        var elem;
      ...
      key: "insertBeforeEnd",
      value: function insertBeforeEnd(elem, html) {
        var position;
        position = 'beforeend';
      ...
      value: function create_tabs() {
        ...
        var _this$make_tabs_html = this.make_tabs_html();

        var _this$make_tabs_html2 = _slicedToArray(_this$make_tabs_html, 2);

        html = _this$make_tabs_html2[0];
        jQElem_list = _this$make_tabs_html2[1];
        this.addHTML(html);
      ...
      key: "get_picker_style_context_selector",
      value: function get_picker_style_context_selector() {
      ...
      key: "addDivWithIdAndClasses",
      value: function addDivWithIdAndClasses(id, classes, specialElem) {
        var html;
        html = "<div id=\"".concat(sel_to_id(id), "\" class=\"").concat(classes, "\"></div>");
      ...
      key: "ensure_divs",
      value: function ensure_divs() {
        var classes, elem, id, j, key, key_sel, len1, ref, sel, specialParent, specialParentElem, specialParentSel, specialParentSelKey;
        ref = this.needed_divs; // find the unique id for things like viscanvas and make div if missing
      ...
      key: "make_JQElem",
      value: function make_JQElem(key, sel) {
        var found, jqelem_id;
      ...
      key: "make_JQElems",
      value: function make_JQElems() {
        var j, key, len1, ref, sel;
        ref = this.needed_JQElems; // Make jQuery elems like @viscanvas_JQElem and performance_dashboard_JQElem
      ...
      key: "make_default_args",
      value: function make_default_args() {
        return {
      ...
      key: "calculate_args",
      value: function calculate_args(incoming_args) {
        var args; // overlay incoming over defaults to make the composition
        ...
        args = this.compose_object_from_defaults_and_incoming(this.make_default_args(), incoming_args); // calculate some args from others
    ...
    function Huviz(incoming_args) {
      ...
      this.fullscreen = this.fullscreen.bind(this); //#### ------------------- collapse/expand stuff ---------------- ########

      this.collapse_tabs = this.collapse_tabs.bind(this); //@expandCtrlJQElem.show() # why does this not work instead of the above?

      this.expand_tabs = this.expand_tabs.bind(this); //checked: "checked"

      this.dump_current_settings = this.dump_current_settings.bind(this);
      this.init_settings_from_json = this.init_settings_from_json.bind(this); //$(@settingGroupsContainerElem).accordion()
      ...
      this.change_graph_settings = this.change_graph_settings.bind(this); // TODO could it be that some of these need their handlers run? eg on_change_SOME_SETTING_NAME
      ...
      this.oldToUniqueTabSel = {}; //if @pfm_display is true
      //  @pfm_dashboard()
      ...
      this.reset_graph();
      this.updateWindow();
      this.ctx = this.canvas.getContext("2d"); //console.log @ctx

      this.mouse_receiver.on("mousemove", this.mousemove).on("mousedown", this.mousedown).on("mouseup", this.mouseup).on("contextmenu", this.mouseright); //.on("mouseout", @mouseup) # FIXME what *should* happen on mouseout?
    ...
    _createClass(Huviz, [{
      key: "maybe_demo_round_img",
      value: function maybe_demo_round_img() {
        var e, roundImage;
      ...
      key: "create_blurtbox",
      value: function create_blurtbox() {
        var blurtbox_id, html, tabsElem;
        blurtbox_id = this.unique_id('blurtbox_');
        tabsElem = document.querySelector('#' + this.tabs_id);
        html = "<div id=\"".concat(blurtbox_id, "\" class=\"blurtbox\"></div>");
        this.blurtbox_JQElem = $(this.insertBeforeEnd(tabsElem, html));
      }
    }, {
      key: "blurt",
      value: function blurt(str, type, noButton) {
        var label; //css styles for messages: info (blue), alert (yellow), error (red)
        ...
        this.blurtbox_JQElem.append("<div class='blurt ".concat(type, "'>").concat(label).concat(str, "<br class='clear'></div>"));
      ...
      key: "close_blurt_box",
      value: function close_blurt_box() {
        delete this.close_blurtbox_button;
        return this.blurtbox_JQElem.html('');
      } //#### ------------------- fullscreen stuff ---------------- ########

    }, {
      key: "create_fullscreen_handle",
      value: function create_fullscreen_handle() {
        var fs;
      ...
      key: "expand_tabs",
      value: function expand_tabs() {
        this.tabsJQElem.prop('style', 'visibility:visible'); //@tabsJQElem.find('.expand_cntrl').prop('style','visibility:hidden')
      ...
      key: "goto_tab",
      value: function goto_tab(tab_idx) {
        this.tabsJQElem.tabs({
          active: tab_idx,
          collapsible: true
        });
      ...
      key: "replace_human_term_spans",
      value: function replace_human_term_spans(optional_class) {
        var canonical, human, ref, results1, selector;
        optional_class = optional_class || 'a_human_term';
        ref = this.human_term; //if console and console.info
        ...
        for (canonical in ref) {
          human = ref[canonical];
          selector = '.human_term__' + canonical; //console.log("replacing '#{canonical}' with '#{human}' in #{selector}")
      ...
      key: "dump_current_settings",
      value: function dump_current_settings(post) {
      ...
      key: "auto_adjust_settings",
      value: function auto_adjust_settings() {
        // Try to tune the gravity, charge and link length to suit the data and the canvas size.
        return this;
      }
    }, {
      key: "make_settings_group",
      value: function make_settings_group(groupName) {
        return this.insertBeforeEnd(this.settingGroupsContainerElem, "<h1>".concat(groupName, "</h1><div class=\"settingsGroup\"></div>"));
      }
    }, {
      key: "get_or_create_settings_group",
      value: function get_or_create_settings_group(groupName) {
        var group, groupId;
      ...
      key: "init_settings_from_json",
      value: function init_settings_from_json() {
        var WidgetClass, control, controlElem, control_name, control_spec, event_type, groupElem, groupName, inputElem, inputId, j, k, labelElem, len1, old_val, opt, optIdx, optionElem, ref, ref1, ref2, ref3, settings_input_sel, v, value; // TODO rebuild this method without D3 using @settingsElem
        ...
        for (j = 0, len1 = ref.length; j < len1; j++) {
          ...
          for (control_name in control_spec) {
            ...
            controlElem = this.insertBeforeEnd(groupElem, "<div class=\"a_setting ".concat(control_name, "__setting\"></div>"));
            labelElem = this.insertBeforeEnd(controlElem, "<label for=\"".concat(inputId, "\"></label>"));
            ...
            if (control.input != null) {
              if (control.input.type === 'select') {
                ...
                for (optIdx in ref1) {
                  opt = ref1[optIdx];
                  optionElem = this.insertBeforeEnd(inputElem, "<option value=\"".concat(opt.value, "\"></option>"));
                ...
                inputElem = this.insertBeforeEnd(controlElem, "<input name=\"".concat(control_name, "\"></input>"));
                WidgetClass = null;
                ref2 = control.input;
      ...
      key: "update_settings_cursor",
      value: function update_settings_cursor(evt) {
        var cursor_text;
      ...
      key: "update_graph_settings",
      value: function update_graph_settings(event) {
        return this.change_graph_settings(event, true);
      }
    }, {
      key: "change_graph_settings",
      value: function change_graph_settings(event, update) {
        ...
        if (target.type === "checkbox") {
          ...
          // must massage into something useful
        ...
        this.change_setting_to_from(target.name, cooked_value, old_value); //d3.select(target).attr("title", cooked_value)

        if (update) {
          // TODO be more discriminating, not all settings require update
      ...
      key: "apply_settings",
      value: function apply_settings(settings) {
      ...
      key: "change_setting_to_from",
      value: function change_setting_to_from(setting_name, new_value, old_value, skip_custom_handler) {
        var cursor_text, custom_handler, custom_handler_name;
        skip_custom_handler = skip_custom_handler != null && skip_custom_handler || false; // TODO replace control.event_type with autodetecting on_change_ vs on_update_ method existence

        custom_handler_name = "on_change_" + setting_name;
        custom_handler = this[custom_handler_name];

        if (this.settings_cursor) {
          cursor_text = new_value.toString(); //console.info("#{setting_name}: #{cursor_text}")
      ...
      key: "on_change_use_accordion_for_settings",
      value: function on_change_use_accordion_for_settings(new_val, old_val) {
        var _this50 = this;
        ...
        if (new_val) {
          ...
          doit = function doit() {
            return $(_this50.settingGroupsContainerElem).accordion();
          };
      ...
      key: "on_change_nodes_pinnable",
      value: function on_change_nodes_pinnable(new_val, old_val) {
      ...
      key: "on_change_show_hunt_verb",
      value: function on_change_show_hunt_verb(new_val, old_val) {
        var vset;
      ...
      key: "on_change_show_dangerous_datasets",
      value: function on_change_show_dangerous_datasets(new_val, old_val) {
        if (new_val) {
      ...
      key: "on_change_pill_display",
      value: function on_change_pill_display(new_val) {
        if (new_val) {
      ...
      key: "on_change_theme_colors",
      value: function on_change_theme_colors(new_val) {
        if (new_val) {
          renderStyles = themeStyles.dark; //$("body").removeClass themeStyles.light.themeName

          this.topElem.classList.remove(themeStyles.light.themeName);
        } else {
          renderStyles = themeStyles.light; //$("body").removeClass themeStyles.dark.themeName
      ...
      key: "on_change_display_label_cartouches",
      value: function on_change_display_label_cartouches(new_val) {
        if (new_val) {
      ...
      key: "on_change_display_shelf_clockwise",
      value: function on_change_display_shelf_clockwise(new_val) {
        if (new_val) {
      ...
      key: "on_change_choose_node_display_angle",
      value: function on_change_choose_node_display_angle(new_val) {
        nodeOrderAngle = new_val;
        return this.updateWindow();
      }
    }, {
      key: "on_change_shelf_radius",
      value: function on_change_shelf_radius(new_val, old_val) {
        this.change_setting_to_from('shelf_radius', new_val, old_val, true);
        this.update_graph_radius();
        return this.updateWindow();
      }
    }, {
      key: "on_change_truncate_labels_to",
      value: function on_change_truncate_labels_to(new_val, old_val) {
        var j, len1, node, ref;
      ...
      key: "on_change_graph_title_style",
      value: function on_change_graph_title_style(new_val, old_val) {
        ...
        this.dataset_watermark_JQElem.removeClass().addClass("dataset_watermark ".concat(new_val));
        return this.ontology_watermark_JQElem.removeClass().addClass("ontology_watermark ".concat(new_val));
      }
    }, {
      key: "on_change_graph_custom_main_title",
      value: function on_change_graph_custom_main_title(new_val) {
        // if new custom values then update titles
        return this.dataset_watermark_JQElem.text(new_val);
      }
    }, {
      key: "on_change_graph_custom_sub_title",
      value: function on_change_graph_custom_sub_title(new_val) {
        return this.ontology_watermark_JQElem.text(new_val);
      }
    }, {
      key: "on_change_language_path",
      value: function on_change_language_path(new_val, old_val) {
        var e, ref;
      ...
      key: "on_change_color_nodes_as_pies",
      value: function on_change_color_nodes_as_pies(new_val, old_val) {
        // TODO why this == window ??
        this.color_nodes_as_pies = new_val;
        return this.recolor_nodes();
      }
    }, {
      key: "on_change_prune_walk_nodes",
      value: function on_change_prune_walk_nodes(new_val, old_val) {
        return this.prune_walk_nodes = new_val;
      }
    }, {
      key: "on_change_show_hide_endpoint_loading",
      value: function on_change_show_hide_endpoint_loading(new_val, old_val) {
        var endpoint;
      ...
      key: "on_change_show_hide_performance_monitor",
      value: function on_change_show_hide_performance_monitor(new_val, old_val) {
      ...
      key: "on_change_discover_geonames_remaining",
      value: function on_change_discover_geonames_remaining(new_val, old_val) {
        this.discover_geonames_remaining = parseInt(new_val, 10);
        return this.discover_names_including('sws.geonames.org');
      }
    }, {
      key: "on_change_discover_geonames_as",
      value: function on_change_discover_geonames_as(new_val, old_val) {
      ...
      key: "on_change_single_chosen",
      value: function on_change_single_chosen(new_val, old_val) {
        this.single_chosen = new_val;
        return this.tick();
      }
    }, {
      key: "on_change_arrows_chosen",
      value: function on_change_arrows_chosen(new_val, old_val) {
        this.arrows_chosen = new_val;
        return this.tick();
      }
    }, {
      key: "init_from_settings",
      value: function init_from_settings() {
        var elem, j, len1, ref, results1;
        ref = $(".settings input"); // so we can modify them in a loop
      ...
      key: "after_file_loaded",
      value: function after_file_loaded(uri, callback) {
      ...
      key: "show_node_pred_edge_stats",
      value: function show_node_pred_edge_stats() {
        var edge_count, pred_count, s;
        pred_count = 0;
        edge_count = 0;
        s = "nodes:".concat(this.nodes.length, " predicates:").concat(pred_count, " edges:").concat(edge_count);
        return console.log(s);
      }
    }, {
      key: "call_on_dataset_loaded",
      value: function call_on_dataset_loaded(uri) {
      ...
      key: "XXX_load_file",
      value: function XXX_load_file() {
        return this.load_data_with_onto(this.get_dataset_uri());
      }
    }, {
      key: "load_data_with_onto",
      value: function load_data_with_onto(data, onto, callback) {
        // Used for loading files from menu
        ...
        this.show_state_msg("loading..."); //@init_from_settings() # REVIEW remove init_from_settings?!?
      ...
      key: "disable_data_set_selector",
      value: function disable_data_set_selector() {
        $("[name=data_set]").prop('disabled', true);
        return $("#reload_btn").show();
      }
    }, {
      key: "XXX_read_data_and_show",
      value: function XXX_read_data_and_show(filename, data) {
        //Handles drag-and-dropped files
        var the_parser; // REVIEW is this no longer used?

        data = this.local_file_data; //console.log data
        ...
        if (filename.match(/.ttl$/)) {
          ...
          alert("Unknown file format. Unable to parse '".concat(filename, "'. Only .ttl and .nq files supported."));
          return;
        }

        the_parser(data); //@local_file_data = "" #RESET the file data
        //@disable_data_set_selector()
      ...
      key: "get_dataset_uri",
      value: function get_dataset_uri() {
        // FIXME goodbye jquery
        return $("select.file_picker option:selected").val();
      }
    }, {
      key: "run_script_from_hash",
      value: function run_script_from_hash() {
        var script;
      ...
      key: "get_script_from_hash",
      value: function get_script_from_hash() {
        var script;
      ...
      key: "adjust_menus_from_load_cmd",
      value: function adjust_menus_from_load_cmd(cmd) {
      ...
      key: "load_script_from_JSON",
      value: function load_script_from_JSON(json) {
        var cmdArgs, j, len1, saul_goodman; //alert('load_script_from_JSON')
      ...
      key: "parse_script_file",
      value: function parse_script_file(data, fname) {
        var line, lines; // There are two file formats, both with the extension .txt
      ...
      key: "boot_sequence",
      value: function boot_sequence(script) {
        var data_uri; // If we are passed an empty string that means there was an outer
        ...
        if (script != null && script.length) {
          console.log("boot_sequence('".concat(script, "')"));
      ...
      key: "load",
      value: function load(data_uri, callback) {
        if (!this.G.subjects) {
      ...
      key: "load_with",
      value: function load_with(data_uri, ontology_uris) {
      ...
      key: "assign_types",
      value: function assign_types(node, within) {
        var type_id;
      ...
      key: "get_default_set_by_type",
      value: function get_default_set_by_type(node) {
        var ref; // see Orlando.get_default_set_by_type
      ...
      value: function pfm_update() {
        ...
        $("#noP").html("".concat(noP)); //TODO Should improve this by avoiding recount every second
        ...
        $("#noC").html("".concat(this.pfm_data.taxonomy.total_count));
        $("#noTicks").html("".concat(this.pfm_data.tick.total_count));
        $("#noAddQuad").html("".concat(this.pfm_data.add_quad.total_count));
        $("#noSparql").html("".concat(this.pfm_data.sparql.total_count));
        ...
        $("#noOR").html("".concat(noOR));
        results1 = [];

        for (pfm_marker in this.pfm_data) {
          marker = this.pfm_data["".concat(pfm_marker)];
          old_count = marker.prev_total_count;
          new_count = marker.total_count;
          calls_per_second = Math.round(new_count - old_count);

          if (this.pfm_data["".concat(pfm_marker)]["timed_count"] && this.pfm_data["".concat(pfm_marker)]["timed_count"].length > 0) {
            //console.log marker.label + "  " + calls_per_second
            if (this.pfm_data["".concat(pfm_marker)]["timed_count"].length > 60) {
              this.pfm_data["".concat(pfm_marker)]["timed_count"].shift();
            }

            this.pfm_data["".concat(pfm_marker)].timed_count.push(calls_per_second);
            this.pfm_data["".concat(pfm_marker)].prev_total_count = new_count + 0.01; //console.log "#pfm_#{pfm_marker}"

            results1.push(sparkline.sparkline(document.querySelector("#pfm_".concat(pfm_marker)), this.pfm_data["".concat(pfm_marker)].timed_count));
          } else if (this.pfm_data["".concat(pfm_marker)]["timed_count"]) {
            results1.push(this.pfm_data["".concat(pfm_marker)]["timed_count"] = [0.01]);
          } else {
            results1.push(void 0);
          }
        }
  ...
  Huviz.prototype.turtle_parser = 'GreenerTurtle'; //turtle_parser: 'N3'

  Huviz.prototype.use_canvas = true;
  Huviz.prototype.use_svg = false;
  Huviz.prototype.use_webgl = false; //use_webgl: true  if location.hash.match(/webgl/)
  ...
  Huviz.prototype.line_length_min = 4; // TODO figure out how to replace with the default_graph_control
  ...
  */
  ...
  Huviz.prototype.last_quad = {}; // add_quad is the standard entrypoint for all data sources
  ...
  Huviz.prototype.snippet_positions_filled = {}; // TODO make other than 'anything' optional
  ...
  return Huviz;
}.call(void 0); //console.log "Setting #{marker.label }to zero"


OntologicallyGrounded =
/*#__PURE__*/
function (_Huviz) {
  _inherits(OntologicallyGrounded, _Huviz);

  function OntologicallyGrounded() {
    var _this51;

    _classCallCheck(this, OntologicallyGrounded);

    _this51 = _possibleConstructorReturn(this, _getPrototypeOf(OntologicallyGrounded).apply(this, arguments));
    _this51.parseTTLOntology = _this51.parseTTLOntology.bind(_assertThisInitialized(_this51));
    return _this51;
  ...
  _createClass(OntologicallyGrounded, [{
    key: "set_ontology",
    value: function set_ontology(ontology_uri) {
      //@init_ontology()
      return this.read_ontology(ontology_uri);
    }
  }, {
    key: "read_ontology",
    value: function read_ontology(url) {
      var _this52 = this;

      if (url.startsWith('file:///') || url.indexOf('/') === -1) {
        // ie local file stored in datasetDB
        this.get_resource_from_db(url, function (err, rsrcRec) {
          if (rsrcRec != null) {
            _this52.parseTTLOntology(rsrcRec.data);

            return;
          }

          _this52.blurt(err || "'".concat(url, "' was not found in your ONTOLOGY menu.  Provide it and reload page"));

          _this52.reset_dataset_ontology_loader();
        });
        return;
      }
      ...
      return $.ajax({
        ...
        error: function error(jqxhr, textStatus, errorThrown) {
          ...
          return _this52.show_state_msg(errorThrown + " while fetching ontology " + url);
        }
      });
    }
  }, {
    key: "parseTTLOntology",
    value: function parseTTLOntology(data, textStatus) {
      var frame, label, obj, obj_lid, obj_raw, ontology, pred, pred_id, pred_lid, ref, results1, subj_lid, subj_uri;
      boundMethodCheck(this, OntologicallyGrounded); // detect (? rdfs:subClassOf ?) and (? ? owl:Class)
            ...
            for (pred_id in ref1) {
              ...
              results2.push(function () {
                ...
                for (j = 0, len1 = ref2.length; j < len1; j++) {
                  ...
                  obj_lid = uniquer(obj_raw); //if pred_lid in ['range','domain']
...
Orlando = function () {
  ...
  var Orlando =
  /*#__PURE__*/
  function (_OntologicallyGrounde) {
    _inherits(Orlando, _OntologicallyGrounde);
    ...
    function Orlando() {
      ...
      _classCallCheck(this, Orlando);

      var delay, _onceDBReady, onceDBReadyCount;

      _this53 = _possibleConstructorReturn(this, _getPrototypeOf(Orlando).apply(this, arguments));

      if (window.indexedDB) {
        onceDBReadyCount = 0;
        delay = 100;

        _onceDBReady = function onceDBReady() {
          onceDBReadyCount++;
          console.log('onceDBReady() call #' + onceDBReadyCount);

          if (_this53.datasetDB != null) {
            console.log('finally! datasetDB is now ready');
            return _this53.run_script_from_hash();
          } else {
            return setTimeout(_onceDBReady, delay); // causes this method to be run again, acting as an async loop
          }
        };

        setTimeout(_onceDBReady, delay);
      } else {
        // REVIEW not sure if this is worth doing (are we requiring indexedDB absolutely?)
        _this53.run_script_from_hash();
      }

      return _this53;
    }

    _createClass(Orlando, [{
      key: "get_default_set_by_type",
      value: function get_default_set_by_type(node) {
        var ref;
      ...
      key: "make_link",
      value: function make_link(uri, text, target) {
        if (uri == null) {
          uri = "";
        }
        ...
        return "<a target=\"".concat(target, "\" href=\"").concat(uri, "\">").concat(text, "</a>");
      }
    }, {
      key: "push_snippet",
      value: function push_snippet(msg_or_obj) {
        ...
        if (this.snippet_box) {
          if (typeof msg_or_obj !== 'string') {
            var _ref = ["", msg_or_obj // swap them
            ];
            msg_or_obj = _ref[0];
            m = _ref[1];

            if (obj.quad.obj_uri) {
              obj_dd = "".concat(this.make_link(obj.quad.obj_uri));
            } else {
              dataType_uri = m.edge.target.__dataType || "";
              dataType = "";

              if (dataType_uri) {
                dataType_curie = m.edge.target.type.replace('__', ':'); //dataType = """^^<a target="_" href="#{dataType_uri}">#{dataType_curie}</a>"""

                dataType = "^^".concat(this.make_link(dataType_uri, dataType_curie));
              }

              obj_dd = "\"".concat(obj.quad.obj_val, "\"").concat(dataType);
            }

            msg_or_obj = "<div id=\"".concat(obj.snippet_js_key, "\">\n  <div style=\"font-size:").concat(fontSize, "em\">\n    <h3>subject</h3>\n    <div class=\"snip_circle\" style=\"background-color:").concat(m.edge.source.color, "; width: ").concat(fontSize * 2.5, "em; height: ").concat(fontSize * 2.5, "em;\"></div>\n    <p style=\"margin-left: ").concat(fontSize * 3.5, "em\">").concat(this.make_link(obj.quad.subj_uri), "</p>\n\n    <h3>predicate </h3>\n    <div class=\"snip_arrow\">\n      <div class=\"snip_arrow_stem\" style=\"width: ").concat(fontSize * 2, "em; height: ").concat(fontSize * 1, "em; margin-top: ").concat(fontSize * 0.75, "em; background-color:").concat(m.edge.color, ";\"></div>\n      <div class=\"snip_arrow_head\" style=\"border-color: transparent transparent transparent ").concat(m.edge.color, ";border-width: ").concat(fontSize * 1.3, "em 0 ").concat(fontSize * 1.3, "em ").concat(fontSize * 2.3, "em;\"></div>\n    </div>\n    <p class=\"pred\" style=\"margin-left: ").concat(fontSize * 4.8, "em\">").concat(this.make_link(obj.quad.pred_uri), "</p>\n\n    <h3>object </h3>\n    <div class=\"snip_circle\" style=\"background-color:").concat(m.edge.target.color, "; width: ").concat(fontSize * 2.5, "em; height: ").concat(fontSize * 2.5, "em;\"></div>\n    <p style=\"margin-left: ").concat(fontSize * 3.5, "em\">").concat(obj_dd, "</p>\n\n    <h3>source</h3>\n    <p style=\"margin-left: ").concat(fontSize * 2.5, "em\">").concat(this.make_link(obj.quad.graph_uri), "</p>\n  </div>\n</div>\n");
          } //# unconfuse emacs Coffee-mode: " """ ' '  "


          return _get(_getPrototypeOf(Orlando.prototype), "push_snippet", this).call(this, obj, msg_or_obj); // fail back to super
        }
      }
    }]);
...
OntoViz = function () {
  ...
  /*#__PURE__*/
  function (_Huviz2) {
    _inherits(OntoViz, _Huviz2);

    function OntoViz() {
      _classCallCheck(this, OntoViz);

      return _possibleConstructorReturn(this, _getPrototypeOf(OntoViz).apply(this, arguments));
    }

    _createClass(OntoViz, [{
      key: "DEPRECATED_try_to_set_node_type",
      //OntologicallyGrounded
      value: function DEPRECATED_try_to_set_node_type(node, type) {
  ...
  OntoViz.prototype.snippet_count_on_edge_labels = false; // first, rest and members are produced by GreenTurtle regarding the AllDisjointClasses list
...
Socrata = function () {
  ...
  /*#__PURE__*/
  function (_Huviz3) {
    _inherits(Socrata, _Huviz3);

    function Socrata() {
      var _this54;

      _classCallCheck(this, Socrata);

      _this54 = _possibleConstructorReturn(this, _getPrototypeOf(Socrata).apply(this, arguments));
      _this54.parseAndShowJSON = _this54.parseAndShowJSON.bind(_assertThisInitialized(_this54));
      return _this54;
    }

    _createClass(Socrata, [{
      key: "ensure_category",
      value: function ensure_category(category_name) {
        var cat_id;
      ...
      key: "assert_name",
      value: function assert_name(uri, name, g) {
      ...
      key: "assert_instanceOf",
      value: function assert_instanceOf(inst, clss, g) {
        return this.add_quad({
          s: inst,
          p: RDF_a,
          o: {
      ...
      key: "assert_propertyValue",
      value: function assert_propertyValue(sub_uri, pred_uri, literal) {
      ...
      key: "assert_relation",
      value: function assert_relation(subj_uri, pred_uri, obj_uri) {
      ...
      key: "parseAndShowJSON",
      value: function parseAndShowJSON(data) {
        var cat_id, dataset, g, j, k, len1, q, results1, v;
        boundMethodCheck(this, Socrata); //TODO Currently not working/tested

        console.log("parseAndShowJSON", data);
        g = this.DEFAULT_CONTEXT; //  https://data.edmonton.ca/api/views/sthd-gad4/rows.json

        results1 = [];

        for (j = 0, len1 = data.length; j < len1; j++) {
          dataset = data[j]; //dataset_uri = "https://data.edmonton.ca/api/views/#{dataset.id}/"
...
PickOrProvide = function () {
  ...
  function () {
    function PickOrProvide(huviz, append_to_sel, label1, css_class, isOntology, isEndpoint, opts) {
      _classCallCheck(this, PickOrProvide);

      var dndLoaderClass;
      this.add_uri = this.add_uri.bind(this);
      this.add_local_file = this.add_local_file.bind(this);
      this.add_resource_option = this.add_resource_option.bind(this); //console.info "form", @form
      ...
      this.drag_and_drop_loader.form.hide(); //@add_group({label: "-- Pick #{@label} --", id: @pickable_uid})
      ...
      this.add_option({
        label: "Provide New ".concat(this.label, " ..."),
        value: 'provide'
      }, this.select_id);
      this.add_option({
    ...
    _createClass(PickOrProvide, [{
      key: "val",
      value: function val(_val) {
        console.log(this.constructor.name + '.val(' + (_val && '"' + _val + '"' || '') + ') for ' + this.opts.rsrcType + ' was ' + this.pick_or_provide_select.val());
        this.pick_or_provide_select.val(_val);
        return this.refresh();
      }
    }, {
      key: "disable",
      ...
      value: function select_option(option) {
        var cur_val, new_val;
        new_val = option.val(); //console.table([{last_val: @last_val, new_val: new_val}])

        cur_val = this.pick_or_provide_select.val(); // TODO remove last_val = null in @init_resource_menus() by fixing logic below
      ...
      key: "add_uri",
      value: function add_uri(uri_or_rec) {
        var rsrcRec, uri;
      ...
      key: "add_local_file",
      value: function add_local_file(file_rec) {
        var rsrcRec, uri; // These are local files which have been 'uploaded' to the browser.
      ...
      key: "add_resource",
      value: function add_resource(rsrcRec, store_in_db) {
        var uri;
        uri = rsrcRec.uri; //rsrcRec.uri ?= uri.split('/').reverse()[0]
      ...
      key: "add_resource_option",
      value: function add_resource_option(rsrcRec) {
        // TODO rename to rsrcRec
        var uri;
        uri = rsrcRec.uri;
      ...
      key: "add_group",
      value: function add_group(grp_rec, which) {
        var optgrp;
        ...
        optgrp = $("<optgroup label=\"".concat(grp_rec.label, "\" id=\"").concat(grp_rec.id || this.huviz.unique_id(), "\"></optgroup>"));
      ...
      key: "add_option",
      value: function add_option(opt_rec, parent_uid, pre_or_append) {
        ...
        if (this.pick_or_provide_select.find("option[value='".concat(opt_rec.value, "']")).length) {
          return;
        } //alert "add_option() #{opt_rec.value} collided"


        opt_str = "<option id=\"".concat(this.huviz.unique_id(), "\"></option>");
        opt = $(opt_str);
        opt_group_label = opt_rec.opt_group;

        if (opt_group_label) {
          opt_group = this.pick_or_provide_select.find("optgroup[label='".concat(opt_group_label, "']")); //console.log(opt_group_label, opt_group.length) #, opt_group[0])
          ...
          if (pre_or_append === 'append') {
            $("#".concat(parent_uid)).append(opt);
          } else {
            $("#".concat(parent_uid)).prepend(opt);
          }
        }
        ...
        ref1 = ['isUri', 'canDelete', 'ontologyUri', 'ontology_label']; // TODO standardize on _
      ...
      key: "update_state",
      value: function update_state(callback) {
        ...
        kid_cnt = the_options.length; //console.log("#{@label}.update_state() raw_value: #{raw_value} kid_cnt: #{kid_cnt}")
      ...
      key: "find_or_append_form",
      value: function find_or_append_form() {
        ...
        this.form = $("#".concat(this.uniq_id));
        this.pick_or_provide_select = this.form.find("select[name='pick_or_provide']");
        this.pick_or_provide_select.attr('id', this.select_id); //console.debug @css_class,@pick_or_provide_select
      ...
      key: "delete_selected_option",
      value: function delete_selected_option(e) {
      ...
      key: "delete_option",
      value: function delete_option(opt_elem) {
        var uri;
...
PickOrProvideScript =
/*#__PURE__*/
function (_PickOrProvide) {
  _inherits(PickOrProvideScript, _PickOrProvide);

  function PickOrProvideScript() {
    var _this55;

    _classCallCheck(this, PickOrProvideScript);

    _this55 = _possibleConstructorReturn(this, _getPrototypeOf(PickOrProvideScript).apply(this, arguments));
    _this55.onchange = _this55.onchange.bind(_assertThisInitialized(_this55));
    return _this55;
  }

  _createClass(PickOrProvideScript, [{
    key: "onchange",
    value: function onchange(e) {
      boundMethodCheck(this, PickOrProvideScript);

      _get(_getPrototypeOf(PickOrProvideScript.prototype), "onchange", this).call(this, e);
...
DragAndDropLoader = function () {
  ...
  var DragAndDropLoader =
  /*#__PURE__*/
  function () {
    function DragAndDropLoader(huviz, append_to_sel, picker) {
      _classCallCheck(this, DragAndDropLoader);

      this.huviz = huviz;
      this.append_to_sel = append_to_sel;
      this.picker = picker;
      this.local_file_form_id = this.huviz.unique_id();
      this.local_file_form_sel = "#".concat(this.local_file_form_id);
      this.find_or_append_form();
    ...
    _createClass(DragAndDropLoader, [{
      key: "supports_file_dnd",
      value: function supports_file_dnd() {
        var div;
      ...
      key: "load_uri",
      value: function load_uri(firstUri) {
      ...
      key: "load_file",
      value: function load_file(firstFile) {
        var _this56 = this;
        ...
        reader.onload = function (evt) {
          ...
          try {
            ...
            if (filename.match(/.(ttl|.nq)$/)) {
              return _this56.picker.add_local_file({
                uri: firstFile.name,
                opt_group: 'Your Own',
              ...
              _this56.huviz.blurt("Unknown file format. Unable to parse '".concat(filename, "'. ") + "Only .ttl and .nq files supported.", 'alert');

              _this56.huviz.reset_dataset_ontology_loader();

              return $('.delete_option').attr('style', '');
            }
          } catch (error1) {
            e = error1;
            msg = e.toString(); //@form.find('.box__error').show()
            //@form.find('.box__error').text(msg)

            return _this56.huviz.blurt(msg, 'error');
          }
        };
      ...
      value: function find_or_append_form() {
        ...
        this.form.on('submit unfocus', function (evt) {
          var uri, uri_field;
          uri_field = _this57.form.find('.box__uri');
          uri = uri_field.val();

          if (uri_field[0].checkValidity()) {
            uri_field.val('');

            _this57.load_uri(uri);
          }
        ...
        return this.form.on('drop', function (e) {
          ...
          _this57.form.find('.box__input').hide();
          ...
          if (firstUri.length) {
            if (_this57.load_uri(firstUri)) {
              _this57.form.find(".box__success").text('');

              _this57.picker.refresh();
          ...
          if (droppedFiles.length) {
            ...
            if (_this57.load_file(firstFile)) {
              _this57.form.find(".box__success").text('');
          ...
          _this57.form.find('.box__input').show();

          return _this57.picker.refresh();
        });
      }
    }]);
...
DragAndDropLoaderOfScripts =
/*#__PURE__*/
function (_DragAndDropLoader) {
  _inherits(DragAndDropLoaderOfScripts, _DragAndDropLoader);

  function DragAndDropLoaderOfScripts() {
    _classCallCheck(this, DragAndDropLoaderOfScripts);

    return _possibleConstructorReturn(this, _getPrototypeOf(DragAndDropLoaderOfScripts).apply(this, arguments));
  }

  _createClass(DragAndDropLoaderOfScripts, [{
    key: "load_file",
    value: function load_file(firstFile) {
      var _this58 = this;
      ...
      reader.onload = function (evt) {
        ...
        try {
          ...
          if (filename.match(/.(txt|.json)$/)) {
            ...
            return _this58.picker.add_local_file(file_rec);
          } else {
            //$("##{@dataset_loader.select_id} option[label='Pick or Provide...']").prop('selected', true)
            //@huviz.local_file_data = evt.target.result
            _this58.huviz.blurt("Unknown file format. Unable to parse '".concat(filename, "'. ") + "Only .txt and .huviz files supported.", 'alert');

            _this58.huviz.reset_dataset_ontology_loader();

            return $('.delete_option').attr('style', '');
          }
        } catch (error1) {
          err = error1;
          msg = err.toString(); //@form.find('.box__error').show()
          //@form.find('.box__error').text(msg)

          return _this58.huviz.blurt(msg, 'error');
        }
      };
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).Huviz = Huviz;
(typeof exports !== "undefined" && exports !== null ? exports : void 0).Orlando = Orlando;
(typeof exports !== "undefined" && exports !== null ? exports : void 0).OntoViz = OntoViz; //(exports ? this).Socrata = Socrata
...
IndexedDBService = function () {
  ...
  function () {
    ...
    _createClass(IndexedDBService, [{
      key: "expunge_db",
      value: function expunge_db(dbname, callback) {
        var _this = this;

        var del_req; //alert("deleting #{dbname or @dbName}")
      ...
      key: "initialize_db",
      value: function initialize_db(callback) {
        var _this2 = this;
        ...
        when_done = function when_done(db, why, cb, err) {
          _this2.nstoreDB = db;
        ...
        if (this.nstoreDB != null) {
          msg = "nstoreDB already exists with name ".concat(this.dbName);
          ...
          req.onsuccess = function (evt) {
            console.log("onsuccess ".concat(_this2.dbName));
          ...
          req.onupgradeneeded = function (evt) {
            ...
            console.log("onupgradeneeded ".concat(db.name));
            console.log(evt);
            ...
            if (evt.oldVersion < 3) {
              //Only create a new ObjectStore when initializing for the first time
              //alert("createObjectStore('#{@dbStoreName}')")
              store = db.createObjectStore(_this2.dbStoreName, {
                keyPath: 'id',
                autoIncrement: true
              });
              console.log(db);
      ...
      key: "get_dbName",
      value: function get_dbName() {
        return this.huviz.args.editui__dbName || this.dbName_default;
      }
    }, {
      key: "add_node_to_db",
      value: function add_node_to_db(quad) {
  ...
  return IndexedDBService;
}.call(void 0); //trx = @nstoreDB.transaction('spogis', "readwrite")
//trx.oncomplete = (e) =>
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).IndexedDBService = IndexedDBService;
"use strict";
...
function () {
  function IndexedDBStorageController(huviz, dbs) {
    _classCallCheck(this, IndexedDBStorageController);
  ...
  _createClass(IndexedDBStorageController, [{
    key: "register",
    value: function register(huviz) {
      this.huviz = huviz;
    } // called by the HuViz constructor if the `edit_handler` no, no *`storage_controller`*

  }, {
    key: "assert",
    value: function assert(quad) {
      var _this = this;

      var req, store, trx; //if not quad.g?
      //  quad.g = @graph_uri
      ...
      req = store.put(quad);
      return req.onsuccess = function (e) {
        console.log(quad, "added to ObjectStore: ".concat(_this.dbs.dbStoreName));
    ...
    key: "get_graphs",
    value: function get_graphs() {} // returns the list of graphs from `quadstore` so PickOrProvide can show them for picking
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).IndexedDBStorageController = IndexedDBStorageController;
"use strict";
...
//      {"name": "Name",
//       "id":   "ID",
var _mintree2d3tree, test;

_mintree2d3tree = function mintree2d3tree(mintree, out, default_root, use_ids_as_names) {
  var k, node, v;
  ...
  out = out || default_root; //console.log("===============\nadding:\n",mintree,"\nto:\n",out)
...
window.mintree2d3tree = _mintree2d3tree; // test()
"use strict";
...
Node = function () {
  ...
  function () {
    ...
    _createClass(Node, [{
      ...
      key: "prev_point",
      value: function prev_point(point) {
        if (point != null) {
          this.px = point[0];
          this.py = point[1];
        }
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).Node = Node;
"use strict";
...
Predicate = function () {
  ...
  function (_TreeCtrl) {
    ...
    function Predicate(id) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Predicate).apply(this, arguments));
      _this.id = id;
      _this.lid = uniquer(_this.id); // lid means local_id

      _this.all_edges = SortedSet().sort_on("id").named("predicate"); // TODO check for .acquire() bugs re isState('_s') vs isState('_p')
      // An Edge is either selected or unselected, so they are mutually exclusive.
      // Hence .isState("_p") is common and unique to them.

      _this.selected_instances = SortedSet().sort_on("id").named("selected").isState('_p');
      _this.unselected_instances = SortedSet().sort_on("id").named("unselected").isState('_p'); // An Edge is either shown or unshown, they are mutually exclusive.
      ...
      _this.shown_instances = SortedSet().sort_on("id").named("shown").isState("_s"); // unshown edges are those which are unshown and linked to a selected source or target

      _this.unshown_instances = SortedSet().sort_on("id").named("unshown").isState("_s");
      _this.change_map = {
        unselect: _this.unselected_instances,
        select: _this.selected_instances,
        unshow: _this.unshown_instances,
        show: _this.shown_instances
      };
    ...
    _createClass(Predicate, [{
      key: "add_inst",
      value: function add_inst(inst) {
        this.all_edges.add(inst);
        return this.update_state();
      }
    }, {
      key: "update_selected_instances",
      value: function update_selected_instances() {
        var before_count, e, i, len, ref, results;
        before_count = this.selected_instances.length;
        ref = this.all_edges; // FIXME why can @selected_instances not be trusted?
      ...
      key: "update_state",
      value: function update_state(inst, change) {
        this.update_selected_instances();
        return _get(_getPrototypeOf(Predicate.prototype), "update_state", this).call(this, inst, change);
      }
    }, {
      key: "recalc_direct_stats",
      value: function recalc_direct_stats() {
        return [this.count_shown_selected(), this.selected_instances.length];
      }
    }, {
      key: "count_shown_selected",
      value: function count_shown_selected() {
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).Predicate = Predicate;
"use strict";
...
QuadParser = function QuadParser(str_or_stream) {
  _classCallCheck(this, QuadParser);

  events.EventEmitter.call(this); //addEventListener
...
Quad = function Quad(subject, pred, obj, graph) {
  this.s = new RdfUri(subject);
  this.p = new RdfUri(pred);
  this.o = new RdfObject(obj);
...
RdfObject = function RdfObject(val) {
  var match, self;
  self = this;
...
parseQuadLine = function parseQuadLine(line) {
  var g, match, o, p, s;
  ...
  if (line == null || line === "" || line.match(isComment)) {
    ...
    //console.log ("parseQuadLine(",line,")");
    match = line.match(quadRegex); //console.log("match",match);
...
isComment = /^\s*\/\//; // (exports ? this).QuadParser = QuadParser
...
Taxon = function () {
  ...
  function (_TreeCtrl) {
    ...
    function Taxon(id) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Taxon).call(this));
      _this.id = id;
      _this.lid = _this.id; // FIXME @lid should be local @id should be uri, no?
      ...
      _this.instances = SortedSet().named(_this.id).isState('_isa').sort_on("id"); // FIXME state?
      // _tp is for 'taxon-pickedness' and has value selected, unselected or discarded
      //   (should probably be _ts for 'taxon-state'

      _this.discarded_instances = SortedSet().named('discarded').isState('_tp').sort_on("id");
      _this.selected_instances = SortedSet().named('selected').isState('_tp').sort_on("id");
      _this.unselected_instances = SortedSet().named('unselected').isState('_tp').sort_on("id");
      _this.change_map = {
        discard: _this.discarded_instances,
        select: _this.selected_instances,
        unselect: _this.unselected_instances
      };
      return _this;
    ...
    _createClass(Taxon, [{
      key: "get_instances",
      value: function get_instances(hier) {
      ...
      key: "recalc_english",
      value: function recalc_english(in_and_out) {
      ...
      key: "update_english",
      value: function update_english() {
        var evt, in_and_out;

        if (this.id !== "Thing") {
          console.error("update_english(".concat(this.lid, ") should only be called on Thing"));
        }
      ...
      key: "english_from",
      value: function english_from(in_and_out) {
        var english;
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).Taxon = Taxon;
"use strict";
...
TextCursor = function () {
  ...
  function () {
    ...
    _createClass(TextCursor, [{
      key: "font_height",
      value: function font_height() {
        return this.height * this.scale;
      }
    }, {
      key: "set_text",
      value: function set_text(text, temp, bgcolor) {
        var cursor, url; //console.log("set_text(#{text.replace("\n", "\\n")})")
        ...
        if (text) {
          ...
          url = this.cache[text]; //cursor = "url(#{url}) 0 #{@font_height()}, default"

          cursor = "url(".concat(url, ") ").concat(this.pointer_height, " 0, default");
        } else {
          cursor = "default";
        }
      ...
      key: "pause",
      value: function pause(cursor, text) {
      ...
      key: "set_cursor",
      value: function set_cursor(cursor) {
        //console.log("set_cursor(#{@elem})", cursor)
        return $(this.elem).css("cursor", cursor);
      }
    }, {
      key: "make_img",
      value: function make_img(text) {
        var cursor, height, i, id, inset, j, k, len, len1, line, lines, max_width, sel, top, url, voffset; // TODO make a speech bubble sort of thing of low opacity but text of high
        ...
        this.ctx.font = "".concat(this.font_height(), "px ").concat(this.face);
        ...
        url = this.canvas.toDataURL("image/png"); //url = "http://www.smurp.com/smurp_headon.jpg"
        //$("<img>", {src: url}).appendTo("#gclui")

        cursor = "url(".concat(url, "), help"); //$("#gclui").css("cursor", cursor)
      ...
      key: "draw_bubble",
      value: function draw_bubble(x, y, w, h, pointer_height, radius) {
        /*
        http://www.scriptol.com/html5/canvas/speech-bubble.php
        */
        var b, r;
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).TextCursor = TextCursor;
"use strict";
...
function () {
  ...
  _createClass(TreeCtrl, [{
    ...
    value: function get_state() {
      if (this.state == null) {
        alert("".concat(this.id, " has no direct state"));
      }

      return this.state;
    }
  }, {
    key: "get_indirect_state",
    value: function get_indirect_state() {
      if (this.indirect_state == null) {
        alert("".concat(this.id, " has no indirect_state"));
      }

      return this.indirect_state;
    }
  }, {
    key: "register_superclass",
    value: function register_superclass(super_class) {
      if (super_class === this) {
        return;
      }
    ...
    key: "remove_subclass",
    value: function remove_subclass(sub_class) {
      var idx;
    ...
    key: "register_subclass",
    value: function register_subclass(sub_class) {
      return this.subs.push(sub_class);
    }
  }, {
    key: "recalc_states",
    value: function recalc_states() {
    ...
    key: "recalc_indirect_state",
    value: function recalc_indirect_state() {
      var consensus, i, kid, kid_ind_stt, len, ref; //return @translate_stats_to_state @indirect_state
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        kid = ref[i];
        kid_ind_stt = kid.get_indirect_state(); //  debugger
    ...
    value: function clean_up_dirt() {
      ...
      this.dirty = false; // FIXME fold the subroutines into this method for a single pass
    ...
    value: function format_stats(stats) {
      return "".concat(stats[0], "/").concat(stats[1]);
    }
  }, {
    key: "translate_stats_to_state",
    value: function translate_stats_to_state(stats) {
      if (stats[1] === 0) {
        return "empty";
      }
    ...
    key: "recalc_direct_state",
    value: function recalc_direct_state() {
      return this.translate_stats_to_state(this.direct_stats);
    }
  }, {
    key: "get_payload_string",
    value: function get_payload_string() {
      return this.format_stats(this.direct_stats);
    }
  }, {
    key: "get_collapsed_payload_string",
    value: function get_collapsed_payload_string() {
      return this.format_stats(this.indirect_stats);
    }
  }, {
    key: "recalc_indirect_stats",
    value: function recalc_indirect_stats(stats) {
      var i, len, ref, sub;
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).TreeCtrl = TreeCtrl;
"use strict";
...
TreePicker = function () {
  ...
  function () {
    function TreePicker(elem1, root, extra_classes, needs_expander, use_name_as_label, squash_case_during_sort, style_context_selector) {
      _classCallCheck(this, TreePicker);

      this.click_handler = this.click_handler.bind(this);
      this.handle_click = this.handle_click.bind(this); // In ballrm.nq Place has direct_state = undefined because Place has
      ...
      this.style_context_selector = style_context_selector; // The @style_context_selector is only really needed by colortreepicker
    ...
    _createClass(TreePicker, [{
      key: "get_my_id",
      value: function get_my_id() {
      ...
      key: "set_abstract",
      value: function set_abstract(id) {
        return this.id_is_abstract[id] = true;
      }
    }, {
      key: "get_abstract_count",
      value: function get_abstract_count() {
        return Object.keys(this.id_is_abstract).length;
      }
    }, {
      key: "is_abstract",
      value: function is_abstract(id) {
        // ie class has no direct instances but maybe subclasses
        var tmp;
      ...
      key: "uri_to_js_id",
      value: function uri_to_js_id(uri) {
        return uniquer(uri);
      }
    }, {
      key: "get_childrens_ids",
      value: function get_childrens_ids(parent_id) {
        if (parent_id == null) {
      ...
      key: "get_container_elem_within_id",
      value: function get_container_elem_within_id(an_id) {
        var content_elem; // the div with class='container' holding class='contents' divs

        content_elem = this.id_to_elem[an_id][0][0];
        return content_elem.querySelector('.container');
      }
    }, {
      key: "resort_recursively",
      value: function resort_recursively(an_id) {
        ...
        sort_by_first_item = function sort_by_first_item(a, b) {
      ...
      key: "update_label_for_node",
      value: function update_label_for_node(node_id, node_elem) {
        // passing node_elem is optional
        var label_elem; // This takes the current value of @id_to_name[node_id] and displays it in the HTML.
      ...
      key: "get_comparison_value",
      value: function get_comparison_value(node_id, label) {
        var this_term;
      ...
      key: "add_alphabetically",
      value: function add_alphabetically(i_am_in, node_id, label) {
      ...
      key: "add_to_elem_before",
      value: function add_to_elem_before(i_am_in, node_id, before, label) {
        return i_am_in.insert('div', before).attr('class', 'contents').attr('id', node_id); // insert just appends if before is undef
      }
    }, {
      key: "show_tree",
      value: function show_tree(tree, i_am_in, listener, top) {
        var contents_of_me, css_class, i, label, len, my_contents, node_id, picker, ref, rest, results; // http://stackoverflow.com/questions/14511872
      ...
      key: "handle_click",
      value: function handle_click(id) {
      ...
      key: "get_next_state_args",
      value: function get_next_state_args(id) {
        var elem, is_treepicker_collapsed, is_treepicker_indirect_showing, is_treepicker_showing, new_state;
        elem = this.id_to_elem[id];

        if (!elem) {
          throw new Error("elem for '".concat(id, "' not found"));
        }

        is_treepicker_collapsed = elem.classed('treepicker-collapse');
        is_treepicker_showing = elem.classed('treepicker-showing');
        is_treepicker_indirect_showing = elem.classed('treepicker-indirect-showing'); // If the state is not 'showing' then make it so, otherwise 'unshowing'.
      ...
      key: "go_to_next_state",
      value: function go_to_next_state(id, args) {
      ...
      key: "effect_click",
      value: function effect_click(id, new_state, send_leafward, listener, args) {
      ...
      key: "get_or_create_container",
      value: function get_or_create_container(contents) {
        var r;
      ...
      key: "set_name_for_id",
      value: function set_name_for_id(name, id) {
        if (this.use_name_as_label) {
      ...
      key: "add",
      value: function add(new_id, parent_id, name, listener) {
      ...
      key: "get_or_create_expander",
      value: function get_or_create_expander(thing, id) {
        var _this = this;
        ...
        if (thing != null && thing) {
          ...
          return exp.on('click', function () {
            // TODO: make this function a method on the class
            var id2;
            d3.event.stopPropagation();
            id2 = exp[0][0].parentNode.parentNode.getAttribute("id");

            if (id2 !== id) {
              console.error("expander.click() ".concat(id, " <> ").concat(id2));
            }
      ...
      key: "get_or_create_payload",
      value: function get_or_create_payload(thing) {
        var r, thing_id;

        if (thing != null && thing) {
          thing_id = thing[0][0].id;
          r = thing.select("#".concat(thing_id, " > .treepicker-label > .payload"));
      ...
      value: function set_payload(id, value) {
        ...
        if (elem == null) {
          //and elem isnt null
          console.warn("set_payload could not find '".concat(id, "'"));
          return;
        }
      ...
      key: "set_title",
      value: function set_title(id, title) {
        var elem;
        elem = this.id_to_elem[id];
      ...
      key: "set_direct_state",
      value: function set_direct_state(id, state, old_state) {
        var elem;
        ...
        if (!elem) {
          console.warn("set_direct_state(".concat(id, ", ").concat(state, ", ").concat(old_state, ") NO elem for id on @id_to_elem"));
          return;
        }

        if (old_state != null) {
          elem.classed("treepicker-".concat(old_state), false);
        }

        if (state != null) {
          return elem.classed("treepicker-".concat(state), true);
        }
      }
    }, {
      key: "set_indirect_state",
      value: function set_indirect_state(id, state, old_state) {
        var elem;

        if (state == null) {
          console.error("".concat(this.get_my_id(), ".set_indirect_state()"), arguments, "state should never be", void 0);
        }
        ...
        if (!elem) {
          console.warn("set_indirect_state(".concat(id, ", ").concat(state, ", ").concat(old_state, ") NO elem for id on @id_to_elem"));
          return;
        }

        if (old_state != null) {
          elem.classed("treepicker-indirect-".concat(old_state), false);
        }

        if (state != null) {
          return elem.classed("treepicker-indirect-".concat(state), true);
        }
      }
    }, {
      key: "set_both_states_by_id",
      value: function set_both_states_by_id(id, direct_state, indirect_state, old_state, old_indirect_state) {
      ...
      key: "is_leaf",
      value: function is_leaf(id) {
        return this.id_to_children[id] == null || this.id_to_children[id].length === 0;
      }
    }, {
      key: "update_parent_indirect_state",
      value: function update_parent_indirect_state(id) {
        var child_indirect_state, child_is_leaf, new_parent_indirect_state, parent_id, parent_indirect_state; // Update the indirect_state of the parents up the tree
        ...
        if (parent_id != null && parent_id !== id) {
          ...
          parent_indirect_state = this.id_to_state[false][parent_id]; //if not parent_indirect_state?
      ...
      key: "calc_new_indirect_state",
      value: function calc_new_indirect_state(id) {
        var child_id, child_indirect_state, i, len, new_indirect_state, old_direct_state, old_indirect_state, ref; // If every time a node has its direct state change it tells its
      ...
      key: "get_state_by_id",
      value: function get_state_by_id(id, direct_only) {
        if (direct_only == null) {
          direct_only = true;
        }
      ...
      key: "onChangeState",
      value: function onChangeState(evt) {
        var det;
        det = evt.detail;
      ...
      key: "cache_payload",
      value: function cache_payload(det) {
        var update;
        update = false;
      ...
      key: "update_payload_by_id",
      value: function update_payload_by_id(id) {
        var payload;
...
(typeof exports !== "undefined" && exports !== null ? exports : void 0).TreePicker = TreePicker;
"use strict";

// FIXME this should be renamed to make_dom_safe_id()
var uniquer;

uniquer = function uniquer(str) {
  var m, retval;
  m = str.match(/([\w\d\_\-]+)$/g);
  ...
  if (retval.match(/^[^a-zA-Z]/)) {
    retval = "x".concat(retval);
  }

  return retval;
};

(typeof exports !== "undefined" && exports !== null ? exports : void 0).uniquer = uniquer;